...
function clamp(a, min2 = 0, max2 = 1) {
...
function supportsBrowserAnimation(options) {
  ...
  if (!isHTMLElement2((_a = motionValue2 == null ? void 0 : motionValue2.owner) == null ? void 0 : _a.current)) {
    return false;
  }
...
var AsyncMotionValueAnimation = class extends WithPromise {
  ...
  onKeyframesResolved(keyframes2, finalKeyframe, options, sync2) {
    ...
    animation2.finished.then(() => this.notifyFinished()).catch(noop3);
...
var PopChildMeasure = class extends React2.Component {
  getSnapshotBeforeUpdate(prevProps) {
    ...
    if (element && prevProps.isPresent && !this.props.isPresent) {
      ...
      const parentWidth = isHTMLElement2(parent) ? parent.offsetWidth || 0 : 0;
...
function useVisualElement(Component4, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  ...
  const wantsHandoff = (0, import_react23.useRef)(Boolean(optimisedAppearId) && !((_a = window.MotionHandoffIsComplete) == null ? void 0 : _a.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) == null ? void 0 : _b.call(window, optimisedAppearId)));
  useIsomorphicLayoutEffect(() => {
    if (!visualElement)
      return;
...
function createRendererMotionComponent({ preloadedFeatures, createVisualElement, useRender, useVisualState: useVisualState2, Component: Component4 }) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    return (0, import_jsx_runtime7.jsxs)(MotionContext.Provider, { value: context2, children: [MeasureLayout2 && context2.visualElement ? (0, import_jsx_runtime7.jsx)(MeasureLayout2, { visualElement: context2.visualElement, ...configAndProps }) : null, useRender(Component4, props, useMotionRef(visualState, context2.visualElement, externalRef), visualState, isStatic, context2.visualElement)] });
  }
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component4, props, ref, { latestValues }, isStatic) => {
    ...
    const elementProps = Component4 !== import_react27.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
    const { children } = props;
    const renderedChildren = (0, import_react27.useMemo)(() => isMotionValue(children) ? children.get() : children, [children]);
    return (0, import_react27.createElement)(Component4, {
      ...elementProps,
...
var makeUseVisualState = (config) => (props, isStatic) => {
  const context2 = (0, import_react28.useContext)(MotionContext);
...
function ReorderItemComponent({ children, style = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
  ...
  invariant(Boolean(context2), "Reorder.Item must be a child of Reorder.Group");
...
var context = React5.createContext(true);
function forbiddenInRender() {
  throw new Error("A function wrapped in useEffectEvent can't be called during rendering.");
}
var isInvalidExecutionContextForEventFunction = "use" in React5 ? () => {
  try {
    return React5.use(context);
  } catch {
    return false;
  }
} : () => false;
...
function useArrayProp(val, defaultVal) {
  ...
  const [t1, setCache] = (0, import_react51.useState)(t0), [cachedVal, cachedHash] = t1, hash = JSON.stringify(val ?? defaultVal);
...
function useClickOutsideEvent(listener, t0, boundaryElement) {
  ...
  let t3;
  $[7] !== hasListener ? (t3 = [hasListener], $[7] = hasListener, $[8] = t3) : t3 = $[8], (0, import_react51.useEffect)(t2, t3), (0, import_react51.useDebugValue)(listener ? "MouseDown On" : "MouseDown Off");
}
function _temp$9() {
  return EMPTY_ARRAY;
}
function useCustomValidity(ref, customValidity) {
  ...
  let t1;
  $[3] !== customValidity || $[4] !== ref ? (t1 = [customValidity, ref], $[3] = customValidity, $[4] = ref, $[5] = t1) : t1 = $[5], (0, import_react51.useEffect)(t0, t1);
}
...
function useElementSize(element) {
  const $ = (0, import_react_compiler_runtime.c)(3), [size22, setSize] = (0, import_react51.useState)(null);
  let t0, t1;
  return $[0] !== element ? (t0 = () => {
    if (element)
      return _elementSizeObserver.subscribe(element, setSize);
  }, t1 = [element], $[0] = element, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), (0, import_react51.useEffect)(t0, t1), size22;
}
function useGlobalKeyDown(onKeyDown) {
  ...
  let t2;
  $[4] === Symbol.for("react.memo_cache_sentinel") ? (t2 = [], $[4] = t2) : t2 = $[4], (0, import_react51.useEffect)(t1, t2);
}
function useMatchMedia(mediaQueryString, getServerSnapshot2) {
  const $ = (0, import_react_compiler_runtime.c)(4);
  (0, import_react51.useDebugValue)(mediaQueryString);
  let t0;
  ...
  let t1;
  return $[2] !== mediaQueryString ? (t1 = () => window.matchMedia(mediaQueryString).matches, $[2] = mediaQueryString, $[3] = t1) : t1 = $[3], (0, import_react51.useSyncExternalStore)(t0, t1, getServerSnapshot2);
}
...
function createGlobalScopedContext(key2, defaultValue) {
  ...
  return typeof document > "u" ? (0, import_react51.createContext)(defaultValue) : (globalScope[symbol] = globalScope[symbol] || (0, import_react51.createContext)(defaultValue), globalScope[symbol]);
}
var ThemeContext = createGlobalScopedContext("@sanity/ui/context/theme", null);
function ThemeProvider(props) {
  const $ = (0, import_react_compiler_runtime.c)(15), parentTheme = (0, import_react51.useContext)(ThemeContext), {
    children
  ...
  let t2;
  $[9] !== children || $[10] !== theme ? (t2 = (0, import_jsx_runtime12.jsx)(ot, { theme, children }), $[9] = children, $[10] = theme, $[11] = t2) : t2 = $[11];
  let t3;
...
function useRootTheme() {
  const value = (0, import_react51.useContext)(ThemeContext);
  if (!value)
...
function useMediaIndex() {
  ...
  const store = t0;
  return (0, import_react51.useSyncExternalStore)(store.subscribe, store.getSnapshot, getServerSnapshot);
}
...
var Label = (0, import_react51.forwardRef)(function(props, ref) {
...
var Avatar = (0, import_react51.forwardRef)(function(props, ref) {
  ...
  const color3 = t0 === void 0 ? "gray" : t0, status = t1 === void 0 ? "online" : t1, sizeProp = t2 === void 0 ? 1 : t2, {
    avatar
  } = useTheme_v2(), as = import_react_is.default.isValidElementType(asProp) ? asProp : "div", size22 = useArrayProp(sizeProp), _sizeRem = (avatar.sizes[size22[0]] || avatar.sizes[0]).size, _radius = _sizeRem / 2, elementId = (0, import_react51.useId)(), [arrowPosition, setArrowPosition] = (0, import_react51.useState)(animateArrowFrom || arrowPositionProp || "inside"), [imageFailed, setImageFailed] = (0, import_react51.useState)(false), imageId = `avatar-image-${elementId}`;
  let t3, t4;
  ...
  }, t4 = [arrowPosition, arrowPositionProp], $[13] = arrowPosition, $[14] = arrowPositionProp, $[15] = t3, $[16] = t4) : (t3 = $[15], t4 = $[16]), (0, import_react51.useEffect)(t3, t4);
  let t5, t6;
  $[17] !== src ? (t5 = () => {
    src && setImageFailed(false);
  }, t6 = [src], $[17] = src, $[18] = t5, $[19] = t6) : (t5 = $[18], t6 = $[19]), (0, import_react51.useEffect)(t5, t6);
  let t7;
  ...
  let t8, t9;
  $[22] !== size22 ? (t9 = size22.map(_temp$6), $[22] = size22, $[23] = t9) : t9 = $[23], t8 = t9;
  const initialsSize = t8, t10 = typeof as == "string" ? as : void 0;
  let t11;
  $[24] !== color3 ? (t11 = (0, import_jsx_runtime12.jsx)(Arrow$1, { children: (0, import_jsx_runtime12.jsx)("svg", { width: "11", height: "7", viewBox: "0 0 11 7", fill: "none", children: (0, import_jsx_runtime12.jsx)("path", { d: "M6.67948 1.50115L11 7L0 7L4.32052 1.50115C4.92109 0.736796 6.07891 0.736795 6.67948 1.50115Z", fill: color3 }) }) }), $[24] = color3, $[25] = t11) : t11 = $[25];
  let t12;
  $[26] !== __unstable_hideInnerStroke || $[27] !== _radius || $[28] !== _sizeRem || $[29] !== handleImageError || $[30] !== imageFailed || $[31] !== imageId || $[32] !== src ? (t12 = !imageFailed && src && (0, import_jsx_runtime12.jsxs)(AvatarImage, { viewBox: `0 0 ${_sizeRem} ${_sizeRem}`, fill: "none", children: [
  ...
  let t13;
  $[34] !== imageFailed || $[35] !== initials || $[36] !== initialsSize || $[37] !== src ? (t13 = (imageFailed || !src) && initials && (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, { children: (0, import_jsx_runtime12.jsx)(Initials, { children: (0, import_jsx_runtime12.jsx)(InitialsLabel, { forwardedAs: "span", size: initialsSize, weight: "medium", children: initials }) }) }), $[34] = imageFailed, $[35] = initials, $[36] = initialsSize, $[37] = src, $[38] = t13) : t13 = $[38];
  let t14;
  return $[39] !== arrowPosition || $[40] !== as || $[41] !== color3 || $[42] !== ref || $[43] !== restProps || $[44] !== size22 || $[45] !== status || $[46] !== t10 || $[47] !== t11 || $[48] !== t12 || $[49] !== t13 || $[50] !== title ? (t14 = (0, import_jsx_runtime12.jsxs)(StyledAvatar, { as, "data-as": t10, "data-ui": "Avatar", ...restProps, $color: color3, $size: size22, "aria-label": title, "data-arrow-position": arrowPosition, "data-status": status, ref, title, children: [
    t11,
    t12,
    t13
  ] }), $[39] = arrowPosition, $[40] = as, $[41] = color3, $[42] = ref, $[43] = restProps, $[44] = size22, $[45] = status, $[46] = t10, $[47] = t11, $[48] = t12, $[49] = t13, $[50] = title, $[51] = t14) : t14 = $[51], t14;
});
...
var AvatarCounter = (0, import_react51.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(9), {
    count,
    size: t0
  } = props, size22 = useArrayProp(t0 === void 0 ? 1 : t0);
  let t1, t2;
  $[0] !== size22 ? (t2 = size22.map(_temp$5), $[0] = size22, $[1] = t2) : t2 = $[1], t1 = t2;
  const fontSize2 = t1;
  let t3;
  $[2] !== count || $[3] !== fontSize2 ? (t3 = (0, import_jsx_runtime12.jsx)(Label, { as: "span", size: fontSize2, weight: "medium", children: count }), $[2] = count, $[3] = fontSize2, $[4] = t3) : t3 = $[4];
  let t4;
  return $[5] !== ref || $[6] !== size22 || $[7] !== t3 ? (t4 = (0, import_jsx_runtime12.jsx)(StyledAvatarCounter, { $size: size22, "data-ui": "AvatarCounter", ref, children: t3 }), $[5] = ref, $[6] = size22, $[7] = t3, $[8] = t4) : t4 = $[8], t4;
});
...
var AvatarStack = (0, import_react51.forwardRef)(function(props, ref) {
  ...
  const maxLengthProp = t0 === void 0 ? 4 : t0, sizeProp = t1 === void 0 ? 1 : t1, children = import_react51.Children.toArray(childrenProp).filter(import_react51.isValidElement), maxLength = Math.max(maxLengthProp, 0), size22 = useArrayProp(sizeProp), len = children.length, visibleCount = maxLength - 1, extraCount = len - visibleCount, visibleChildren = extraCount > 1 ? children.slice(extraCount, len) : children, T0 = StyledAvatarStack, t2 = "AvatarStack", t3 = len === 0 && (0, import_jsx_runtime12.jsx)("div", { children: (0, import_jsx_runtime12.jsx)(AvatarCounter, { count: len, size: size22 }) }), t4 = len !== 0 && extraCount > 1 && (0, import_jsx_runtime12.jsx)("div", { children: (0, import_jsx_runtime12.jsx)(AvatarCounter, { count: extraCount, size: size22 }) });
  let t5;
  $[5] !== size22 ? (t5 = (child, childIndex) => (0, import_jsx_runtime12.jsx)("div", { children: (0, import_react51.cloneElement)(child, {
    size: size22
  }) }, String(childIndex)), $[5] = size22, $[6] = t5) : t5 = $[6];
  const t6 = visibleChildren.map(t5);
  let t7;
  return $[7] !== T0 || $[8] !== ref || $[9] !== restProps || $[10] !== size22 || $[11] !== t3 || $[12] !== t4 || $[13] !== t6 ? (t7 = (0, import_jsx_runtime12.jsxs)(T0, { "data-ui": t2, ...restProps, ref, $size: size22, children: [
    t3,
    t4,
    t6
  ] }), $[7] = T0, $[8] = ref, $[9] = restProps, $[10] = size22, $[11] = t3, $[12] = t4, $[13] = t6, $[14] = t7) : t7 = $[14], t7;
});
...
var Box = (0, import_react51.forwardRef)(function(props, ref) {
...
var Text = (0, import_react51.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(22);
...
var Badge = (0, import_react51.forwardRef)(function(props, ref) {
...
var Flex = (0, import_react51.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(17);
...
var Spinner = (0, import_react51.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(4);
  let t0;
...
var Button = (0, import_react51.forwardRef)(function(props, ref) {
  ...
  let t14;
  $[35] !== loading ? (t14 = !!loading && (0, import_jsx_runtime12.jsx)(LoadingBox, { children: (0, import_jsx_runtime12.jsx)(Spinner, {}) }), $[35] = loading, $[36] = t14) : t14 = $[36];
  let t15;
  $[37] !== IconComponent || $[38] !== IconRightComponent || $[39] !== boxProps || $[40] !== button || $[41] !== fontSize2 || $[42] !== justify || $[43] !== muted || $[44] !== space || $[45] !== text || $[46] !== textAlign || $[47] !== textWeight ? (t15 = (IconComponent || text || IconRightComponent) && (0, import_jsx_runtime12.jsx)(Box, { as: "span", ...boxProps, children: (0, import_jsx_runtime12.jsxs)(Flex, { as: "span", justify, gap: space, children: [
    IconComponent && (0, import_jsx_runtime12.jsxs)(Text, { size: fontSize2, children: [
      (0, import_react51.isValidElement)(IconComponent) && IconComponent,
    ...
    IconRightComponent && (0, import_jsx_runtime12.jsxs)(Text, { size: fontSize2, children: [
      (0, import_react51.isValidElement)(IconRightComponent) && IconRightComponent,
  ...
  let t16;
  $[49] !== boxProps || $[50] !== children ? (t16 = children && (0, import_jsx_runtime12.jsx)(Box, { as: "span", ...boxProps, children }), $[49] = boxProps, $[50] = children, $[51] = t16) : t16 = $[51];
  let t17;
  return $[52] !== mode || $[53] !== radius || $[54] !== ref || $[55] !== restProps || $[56] !== t11 || $[57] !== t12 || $[58] !== t13 || $[59] !== t14 || $[60] !== t15 || $[61] !== t16 || $[62] !== tone || $[63] !== type || $[64] !== width ? (t17 = (0, import_jsx_runtime12.jsxs)(StyledButton, { "data-ui": "Button", ...restProps, $mode: mode, $radius: radius, $tone: tone, "data-disabled": t11, "data-selected": t12, disabled: t13, ref, type, $width: width, children: [
    t14,
    t15,
    t16
...
var Card = (0, import_react51.forwardRef)(function(props, ref) {
...
var Checkbox = (0, import_react51.forwardRef)(function(props, forwardedRef) {
  ...
  let t0;
  $[9] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref.current, $[9] = t0) : t0 = $[9], (0, import_react51.useImperativeHandle)(forwardedRef, t0);
  let t1, t2;
  $[10] !== indeterminate ? (t1 = () => {
    ref.current && (ref.current.indeterminate = indeterminate || false);
  }, t2 = [indeterminate], $[10] = indeterminate, $[11] = t1, $[12] = t2) : (t1 = $[11], t2 = $[12]), (0, import_react51.useEffect)(t1, t2), useCustomValidity(ref, customValidity);
...
var LazyRefractor = (0, import_react51.lazy)(() => import("./refractor-GOAJJU3X.js"));
var StyledCode = dt.pre.withConfig({
  displayName: "StyledCode",
  componentId: "sc-4dymyn-0"
})(codeBaseStyle, responsiveCodeFontStyle);
var Code = (0, import_react51.forwardRef)(function(props, ref) {
  ...
  let t4;
  $[11] !== t2 || $[12] !== t3 ? (t4 = (0, import_jsx_runtime12.jsx)(import_react51.Suspense, { fallback: t2, children: t3 }), $[11] = t2, $[12] = t3, $[13] = t4) : t4 = $[13];
  let t5;
...
var Container = (0, import_react51.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(9);
  let as, restProps, t0;
  $[0] !== props ? ({
    as,
...
var Grid = (0, import_react51.forwardRef)(function(props, ref) {
...
var Heading = (0, import_react51.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(22);
  let align, childrenProp, restProps, t0, t1, t2, textOverflow, weight;
  $[0] !== props ? ({
    accent: t0,
...
var Inline = (0, import_react51.forwardRef)(function(props, ref) {
  ...
  let t0, t1;
  $[5] !== childrenProp ? (t1 = import_react51.Children.map(childrenProp, _temp$4), $[5] = childrenProp, $[6] = t1) : t1 = $[6], t0 = t1;
  const children = t0, t2 = useArrayProp(space), t3 = ref;
  let t4;
  return $[7] !== as || $[8] !== children || $[9] !== restProps || $[10] !== t2 || $[11] !== t3 ? (t4 = (0, import_jsx_runtime12.jsx)(StyledInline, { "data-ui": "Inline", ...restProps, $space: t2, forwardedAs: as, ref: t3, children }), $[7] = as, $[8] = children, $[9] = restProps, $[10] = t2, $[11] = t3, $[12] = t4) : t4 = $[12], t4;
});
...
var KBD = (0, import_react51.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(17);
...
var Arrow = (0, import_react51.forwardRef)(function(props, ref) {
  ...
  let t2;
  $[5] !== strokeWidth || $[6] !== w ? (t2 = (0, import_jsx_runtime12.jsx)("mask", { id: "stroke-mask", children: (0, import_jsx_runtime12.jsx)("rect", { x: 0, y: strokeWidth, width: w, height: w, fill: "white" }) }), $[5] = strokeWidth, $[6] = w, $[7] = t2) : t2 = $[7];
  const t3 = strokeWidth * 2;
  let t4;
  $[8] !== strokePath || $[9] !== t3 ? (t4 = (0, import_jsx_runtime12.jsx)(StrokePath, { d: strokePath, mask: "url(#stroke-mask)", strokeWidth: t3 }), $[8] = strokePath, $[9] = t3, $[10] = t4) : t4 = $[10];
  let t5;
  $[11] !== fillPath ? (t5 = (0, import_jsx_runtime12.jsx)(ShapePath, { d: fillPath }), $[11] = fillPath, $[12] = t5) : t5 = $[12];
  let t6;
  $[13] !== t1 || $[14] !== t2 || $[15] !== t4 || $[16] !== t5 || $[17] !== w ? (t6 = (0, import_jsx_runtime12.jsxs)("svg", { width: w, height: w, viewBox: t1, children: [
    t2,
    t4,
    t5
  ] }), $[13] = t1, $[14] = t2, $[15] = t4, $[16] = t5, $[17] = w, $[18] = t6) : t6 = $[18];
  let t7;
  return $[19] !== ref || $[20] !== restProps || $[21] !== t6 || $[22] !== w ? (t7 = (0, import_jsx_runtime12.jsx)(StyledArrow, { ...restProps, $w: w, ref, children: t6 }), $[19] = ref, $[20] = restProps, $[21] = t6, $[22] = w, $[23] = t7) : t7 = $[23], t7;
});
...
function BoundaryElementProvider(props) {
  ...
  const value = t0;
  let t2;
  return $[2] !== children || $[3] !== value ? (t2 = (0, import_jsx_runtime12.jsx)(BoundaryElementContext.Provider, { value, children }), $[2] = children, $[3] = value, $[4] = t2) : t2 = $[4], t2;
}
...
function useBoundaryElement() {
  const value = (0, import_react51.useContext)(BoundaryElementContext);
...
var ElementQuery = (0, import_react51.forwardRef)(function(props, forwardedRef) {
  ...
  const media = _media ?? theme.media, [element, setElement] = (0, import_react51.useState)(null), elementSize = useElementSize(element);
  let t0;
  ...
  const min2 = t3;
  let t5, t6;
  $[10] !== element ? (t5 = () => element, t6 = [element], $[10] = element, $[11] = t5, $[12] = t6) : (t5 = $[11], t6 = $[12]), (0, import_react51.useImperativeHandle)(forwardedRef, t5, t6);
  let t7;
  return $[13] !== children || $[14] !== max2 || $[15] !== min2 || $[16] !== restProps ? (t7 = (0, import_jsx_runtime12.jsx)("div", { "data-ui": "ElementQuery", ...restProps, "data-eq-max": max2, "data-eq-min": min2, ref: setElement, children }), $[13] = children, $[14] = max2, $[15] = min2, $[16] = restProps, $[17] = t7) : t7 = $[17], t7;
});
...
function LayerProvider(props) {
  const $ = (0, import_react_compiler_runtime.c)(19), {
    children,
    zOffset: t0
  } = props, zOffsetProp = t0 === void 0 ? 0 : t0, parentContextValue = (0, import_react51.useContext)(LayerContext);
  let t1;
  ...
  const [, setChildLayers] = (0, import_react51.useState)(t2), [size22, setSize] = (0, import_react51.useState)(0), isTopLayer2 = size22 === 0;
  let t3;
  ...
  let t4, t5;
  $[6] !== level || $[7] !== parentRegisterChild ? (t4 = () => parentRegisterChild == null ? void 0 : parentRegisterChild(level), t5 = [level, parentRegisterChild], $[6] = level, $[7] = parentRegisterChild, $[8] = t4, $[9] = t5) : (t4 = $[8], t5 = $[9]), (0, import_react51.useEffect)(t4, t5);
  let t6, t7;
  $[10] !== isTopLayer2 || $[11] !== level || $[12] !== registerChild || $[13] !== size22 || $[14] !== zIndex ? (t7 = {
    version: 0,
    ...
    size: size22,
    zIndex
  }, $[10] = isTopLayer2, $[11] = level, $[12] = registerChild, $[13] = size22, $[14] = zIndex, $[15] = t7) : t7 = $[15], t6 = t7;
  const value = t6;
  let t8;
  return $[16] !== children || $[17] !== value ? (t8 = (0, import_jsx_runtime12.jsx)(LayerContext.Provider, { value, children }), $[16] = children, $[17] = value, $[18] = t8) : t8 = $[18], t8;
}
...
function useLayer() {
  const $ = (0, import_react_compiler_runtime.c)(2), value = (0, import_react51.useContext)(LayerContext);
  if (!value)
...
var LayerChildren = (0, import_react51.forwardRef)(function(props, forwardedRef) {
  const $ = (0, import_react_compiler_runtime.c)(22);
  ...
  const style = t0 === void 0 ? EMPTY_RECORD : t0, {
    zIndex,
    isTopLayer: isTopLayer2
  } = useLayer(), lastFocusedRef = (0, import_react51.useRef)(null), ref = (0, import_react51.useRef)(null), isTopLayerRef = (0, import_react51.useRef)(isTopLayer2);
  let t1;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t1 = () => ref.current, $[6] = t1) : t1 = $[6], (0, import_react51.useImperativeHandle)(forwardedRef, t1);
  let t2, t3;
  ...
  }, t3 = [isTopLayer2, onActivate], $[7] = isTopLayer2, $[8] = onActivate, $[9] = t2, $[10] = t3) : (t2 = $[9], t3 = $[10]), (0, import_react51.useEffect)(t2, t3);
  let t4;
...
var Layer = (0, import_react51.forwardRef)(function(props, ref) {
...
function usePortal() {
  const value = (0, import_react51.useContext)(PortalContext);
  if (!value)
...
function PortalProvider(props) {
  ...
  } = props, elements = useUnique(elementsProp), fallbackElement = (0, import_react51.useSyncExternalStore)(emptySubscribe, _temp$2, _temp2$1);
  let t0;
  ...
  const value = t0;
  let t4;
  return $[4] !== children || $[5] !== value ? (t4 = (0, import_jsx_runtime12.jsx)(PortalContext.Provider, { value, children }), $[4] = children, $[5] = value, $[6] = t4) : t4 = $[6], t4;
}
function _temp2$1() {
  return null;
}
...
var SrOnly = (0, import_react51.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(4), {
    as,
    children
  } = props;
...
var VirtualList = (0, import_react51.forwardRef)(function(props, forwardedRef) {
  ...
  const items = t3, {
    space
  } = useTheme_v2(), ref = (0, import_react51.useRef)(null), wrapperRef = (0, import_react51.useRef)(null), [scrollTop, setScrollTop] = (0, import_react51.useState)(0), [scrollHeight, setScrollHeight] = (0, import_react51.useState)(0), [itemHeight, setItemHeight] = (0, import_react51.useState)(-1);
  let t4;
  $[10] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => ref.current, $[10] = t4) : t4 = $[10], (0, import_react51.useImperativeHandle)(forwardedRef, t4);
  let t5;
  ...
  let t6;
  $[12] !== renderItem ? (t6 = [renderItem], $[12] = renderItem, $[13] = t6) : t6 = $[13], (0, import_react51.useEffect)(t5, t6);
  let t7, t8;
  ...
  }, t8 = [], $[14] = t7, $[15] = t8) : (t7 = $[14], t8 = $[15]), (0, import_react51.useEffect)(t7, t8);
  ...
  }, t10 = [fromIndex, gap, itemHeight, onChange, scrollHeight, scrollTop, space, toIndex], $[16] = fromIndex, $[17] = gap, $[18] = itemHeight, $[19] = onChange, $[20] = scrollHeight, $[21] = scrollTop, $[22] = space, $[23] = toIndex, $[24] = t10, $[25] = t9) : (t10 = $[24], t9 = $[25]), (0, import_react51.useEffect)(t9, t10);
  let t11;
  bb0: {
  ...
  let t14;
  $[49] !== children || $[50] !== wrapperStyle ? (t14 = (0, import_jsx_runtime12.jsx)("div", { ref: wrapperRef, style: wrapperStyle, children }), $[49] = children, $[50] = wrapperStyle, $[51] = t14) : t14 = $[51];
  let t15;
  return $[52] !== as || $[53] !== restProps || $[54] !== t14 ? (t15 = (0, import_jsx_runtime12.jsx)(StyledVirtualList, { as, "data-ui": "VirtualList", ...restProps, ref, children: t14 }), $[52] = as, $[53] = restProps, $[54] = t14, $[55] = t15) : t15 = $[55], t15;
});
...
var PopoverCard = (0, import_react51.memo)((0, import_react51.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(66);
  ...
  let t9;
  $[36] !== animate2 ? (t9 = animate2 ? ["hidden", "initial"] : void 0, $[36] = animate2, $[37] = t9) : t9 = $[37];
  let t10;
  $[38] !== animate2 ? (t10 = animate2 ? ["visible", "scaleIn"] : void 0, $[38] = animate2, $[39] = t10) : t10 = $[39];
  let t11;
  $[40] !== animate2 ? (t11 = animate2 ? ["hidden", "scaleOut"] : void 0, $[40] = animate2, $[41] = t11) : t11 = $[41];
  let t12;
  $[42] !== children || $[43] !== padding ? (t12 = (0, import_jsx_runtime12.jsx)(Flex, { direction: "column", flex: 1, padding, children }), $[42] = children, $[43] = padding, $[44] = t12) : t12 = $[44];
  let t13;
  $[45] !== overflow || $[46] !== t12 ? (t13 = (0, import_jsx_runtime12.jsx)(MotionFlex, { "data-ui": "Popover__wrapper", direction: "column", flex: 1, overflow, variants: POPOVER_MOTION_PROPS.children, transition: POPOVER_MOTION_PROPS.transition, children: t12 }), $[45] = overflow, $[46] = t12, $[47] = t13) : t13 = $[47];
  let t14;
  $[48] !== arrow22 || $[49] !== arrowRef || $[50] !== arrowStyle ? (t14 = arrow22 && (0, import_jsx_runtime12.jsx)(Arrow, { ref: arrowRef, style: arrowStyle, width: DEFAULT_POPOVER_ARROW_WIDTH, height: DEFAULT_POPOVER_ARROW_HEIGHT, radius: DEFAULT_POPOVER_ARROW_RADIUS }), $[48] = arrow22, $[49] = arrowRef, $[50] = arrowStyle, $[51] = t14) : t14 = $[51];
  let t15;
  return $[52] !== placement || $[53] !== radius || $[54] !== ref || $[55] !== rootStyle2 || $[56] !== scheme || $[57] !== shadow || $[58] !== t10 || $[59] !== t11 || $[60] !== t13 || $[61] !== t14 || $[62] !== t8 || $[63] !== t9 || $[64] !== tone ? (t15 = (0, import_jsx_runtime12.jsxs)(MotionCard$1, { "data-ui": "Popover", ...t8, "data-placement": placement, radius, ref, scheme, shadow, sizing: "border", style: rootStyle2, tone, variants: POPOVER_MOTION_PROPS.card, transition: POPOVER_MOTION_PROPS.transition, initial: t9, animate: t10, exit: t11, children: [
    t13,
    t14
...
var Popover = (0, import_react51.memo)((0, import_react51.forwardRef)(function(props, forwardedRef) {
  var _a, _b, _c, _d, _e, _f;
  const {
    container: container2,
    layer
    ...
    updateRef,
    ...restProps
  } = props, animate2 = usePrefersReducedMotion() ? false : _animate, boundarySize = (_a = useElementSize(boundaryElement)) == null ? void 0 : _a.border, padding = useArrayProp(paddingProp), radius = useArrayProp(radiusProp), shadow = useArrayProp(shadowProp), widthArrayProp = useArrayProp(widthProp), zOffset = useArrayProp(zOffsetProp), ref = (0, import_react51.useRef)(null), arrowRef = (0, import_react51.useRef)(null), rootBoundary = "viewport";
  (0, import_react51.useImperativeHandle)(forwardedRef, () => ref.current);
  ...
  }), widthRef = (0, import_react51.useRef)(width);
  ...
  const maxWidth = calcMaxWidth({
    boundaryWidth,
    currentWidth: width
  }), maxWidthRef = (0, import_react51.useRef)(maxWidth);
  (0, import_react51.useEffect)(() => {
    maxWidthRef.current = maxWidth;
  }, [maxWidth]);
  const referenceWidthRef = (0, import_react51.useRef)(void 0);
  (0, import_react51.useEffect)(() => {
  ...
  const middleware = (0, import_react51.useMemo)(() => {
    const ret = [];
  ...
  }, [childProp, refs]), child = (0, import_react51.useMemo)(() => referenceElement ? childProp : childProp ? (0, import_react51.cloneElement)(childProp, {
    ref: setReference
  }) : null, [childProp, referenceElement, setReference]);
  if ((0, import_react51.useEffect)(() => {
...
var Radio = (0, import_react51.forwardRef)(function(props, forwardedRef) {
  const $ = (0, import_react_compiler_runtime.c)(19);
  ...
  const ref = (0, import_react51.useRef)(null);
  let t0;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref.current, $[7] = t0) : t0 = $[7], (0, import_react51.useImperativeHandle)(forwardedRef, t0), useCustomValidity(ref, customValidity);
...
var Select = (0, import_react51.forwardRef)(function(props, forwardedRef) {
  ...
  const fontSize2 = t0 === void 0 ? 2 : t0, padding = t1 === void 0 ? 3 : t1, radius = t2 === void 0 ? 2 : t2, space = t3 === void 0 ? 3 : t3, ref = (0, import_react51.useRef)(null);
  let t4;
  $[10] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => ref.current, $[10] = t4) : t4 = $[10], (0, import_react51.useImperativeHandle)(forwardedRef, t4), useCustomValidity(ref, customValidity);
...
var Stack = (0, import_react51.forwardRef)(function(props, ref) {
...
var Switch = (0, import_react51.forwardRef)(function(props, forwardedRef) {
  const $ = (0, import_react_compiler_runtime.c)(26);
  ...
  const ref = (0, import_react51.useRef)(null);
  let t0;
  $[8] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref.current, $[8] = t0) : t0 = $[8], (0, import_react51.useImperativeHandle)(forwardedRef, t0);
  let t1, t2;
  $[9] !== indeterminate ? (t1 = () => {
    ref.current && (ref.current.indeterminate = indeterminate || false);
  }, t2 = [indeterminate], $[9] = indeterminate, $[10] = t1, $[11] = t2) : (t1 = $[10], t2 = $[11]), (0, import_react51.useEffect)(t1, t2);
...
var TextArea = (0, import_react51.forwardRef)(function(props, forwardedRef) {
  const $ = (0, import_react_compiler_runtime.c)(29);
  ...
  const border2 = t0 === void 0 ? true : t0, disabled = t1 === void 0 ? false : t1, fontSize2 = t2 === void 0 ? 2 : t2, padding = t3 === void 0 ? 3 : t3, radius = t4 === void 0 ? 2 : t4, ref = (0, import_react51.useRef)(null), rootTheme = useRootTheme();
  let t5;
  $[10] === Symbol.for("react.memo_cache_sentinel") ? (t5 = () => ref.current, $[10] = t5) : t5 = $[10], (0, import_react51.useImperativeHandle)(forwardedRef, t5), useCustomValidity(ref, customValidity);
...
var TextInput = (0, import_react51.forwardRef)(function(props, forwardedRef) {
  ...
  const border2 = t0 === void 0 ? true : t0, disabled = t1 === void 0 ? false : t1, fontSizeProp = t2 === void 0 ? 2 : t2, paddingProp = t3 === void 0 ? 3 : t3, radiusProp = t4 === void 0 ? 2 : t4, spaceProp = t5 === void 0 ? 3 : t5, type = t6 === void 0 ? "text" : t6, ref = (0, import_react51.useRef)(null), rootTheme = useRootTheme(), fontSize2 = useArrayProp(fontSizeProp), padding = useArrayProp(paddingProp), radius = useArrayProp(radiusProp), space = useArrayProp(spaceProp), $hasClearButton = !!clearButton, $hasIcon = !!IconComponent, $hasIconRight = !!IconRightComponent, $hasSuffix = !!suffix, $hasPrefix = !!prefix;
  let t7;
  $[19] === Symbol.for("react.memo_cache_sentinel") ? (t7 = () => ref.current, $[19] = t7) : t7 = $[19], (0, import_react51.useImperativeHandle)(forwardedRef, t7), useCustomValidity(ref, customValidity);
  ...
  let t9, t10;
  $[22] !== prefix || $[23] !== radius ? (t10 = prefix && (0, import_jsx_runtime12.jsx)(Prefix, { borderTop: true, borderLeft: true, borderBottom: true, radius, sizing: "border", tone: "inherit", children: (0, import_jsx_runtime12.jsx)("span", { children: prefix }) }), $[22] = prefix, $[23] = radius, $[24] = t10) : t10 = $[24], t9 = t10;
  const prefixNode = t9;
  let t11;
  const t12 = border2 ? "" : void 0;
  let t13;
  $[25] !== IconComponent || $[26] !== fontSize2 || $[27] !== padding ? (t13 = IconComponent && (0, import_jsx_runtime12.jsx)(LeftBox, { padding, children: (0, import_jsx_runtime12.jsxs)(Text, { size: fontSize2, children: [
    (0, import_react51.isValidElement)(IconComponent) && IconComponent,
    (0, import_react_is.isValidElementType)(IconComponent) && (0, import_jsx_runtime12.jsx)(IconComponent, {})
  ] }) }), $[25] = IconComponent, $[26] = fontSize2, $[27] = padding, $[28] = t13) : t13 = $[28];
  let t14;
  $[29] !== $hasClearButton || $[30] !== IconRightComponent || $[31] !== fontSize2 || $[32] !== padding ? (t14 = !$hasClearButton && IconRightComponent && (0, import_jsx_runtime12.jsx)(RightBox, { padding, children: (0, import_jsx_runtime12.jsxs)(Text, { size: fontSize2, children: [
    (0, import_react51.isValidElement)(IconRightComponent) && IconRightComponent,
    (0, import_react_is.isValidElementType)(IconRightComponent) && (0, import_jsx_runtime12.jsx)(IconRightComponent, {})
  ] }) }), $[29] = $hasClearButton, $[30] = IconRightComponent, $[31] = fontSize2, $[32] = padding, $[33] = t14) : t14 = $[33];
  let t15;
  $[34] !== $hasPrefix || $[35] !== $hasSuffix || $[36] !== __unstable_disableFocusRing || $[37] !== radius || $[38] !== rootTheme.scheme || $[39] !== rootTheme.tone || $[40] !== t12 || $[41] !== t13 || $[42] !== t14 ? (t15 = (0, import_jsx_runtime12.jsxs)(Presentation, { $hasPrefix, $unstableDisableFocusRing: __unstable_disableFocusRing, $hasSuffix, $radius: radius, $scheme: rootTheme.scheme, $tone: rootTheme.tone, "data-border": t12, "data-scheme": rootTheme.scheme, "data-tone": rootTheme.tone, children: [
    t13,
    t14
  ...
  let t21, t22;
  $[48] !== clearButton || $[49] !== clearButtonBoxPadding || $[50] !== clearButtonPadding || $[51] !== clearButtonProps || $[52] !== customValidity || $[53] !== disabled || $[54] !== fontSize2 || $[55] !== handleClearClick || $[56] !== radius || $[57] !== readOnly ? (t22 = !disabled && !readOnly && clearButton && (0, import_jsx_runtime12.jsx)(RightCard, { forwardedAs: "span", padding: clearButtonBoxPadding, style: CLEAR_BUTTON_BOX_STYLE, tone: customValidity ? "critical" : "inherit", children: (0, import_jsx_runtime12.jsx)(TextInputClearButton, { "aria-label": "Clear", "data-qa": "clear-button", fontSize: fontSize2, icon: CloseIcon, mode: "bleed", padding: clearButtonPadding, radius, ...clearButtonProps, onClick: handleClearClick, onMouseDown: handleClearMouseDown }) }), $[48] = clearButton, $[49] = clearButtonBoxPadding, $[50] = clearButtonPadding, $[51] = clearButtonProps, $[52] = customValidity, $[53] = disabled, $[54] = fontSize2, $[55] = handleClearClick, $[56] = radius, $[57] = readOnly, $[58] = t22) : t22 = $[58], t21 = t22;
  const clearButtonNode = t21;
  let t23, t24;
  $[59] !== radius || $[60] !== suffix ? (t24 = suffix && (0, import_jsx_runtime12.jsx)(Suffix, { borderTop: true, borderRight: true, borderBottom: true, radius, sizing: "border", tone: "inherit", children: (0, import_jsx_runtime12.jsx)("span", { children: suffix }) }), $[59] = radius, $[60] = suffix, $[61] = t24) : t24 = $[61], t23 = t24;
  const suffixNode = t23, t25 = $hasIconRight || $hasClearButton;
  let t26;
  $[62] !== $hasIcon || $[63] !== disabled || $[64] !== fontSize2 || $[65] !== padding || $[66] !== readOnly || $[67] !== restProps || $[68] !== rootTheme.scheme || $[69] !== rootTheme.tone || $[70] !== space || $[71] !== t25 || $[72] !== type || $[73] !== weight ? (t26 = (0, import_jsx_runtime12.jsx)(Input, { "data-as": "input", "data-scheme": rootTheme.scheme, "data-tone": rootTheme.tone, ...restProps, $fontSize: fontSize2, $iconLeft: $hasIcon, $iconRight: t25, $padding: padding, $scheme: rootTheme.scheme, $space: space, $tone: rootTheme.tone, $weight: weight, disabled, readOnly, ref, type }), $[62] = $hasIcon, $[63] = disabled, $[64] = fontSize2, $[65] = padding, $[66] = readOnly, $[67] = restProps, $[68] = rootTheme.scheme, $[69] = rootTheme.tone, $[70] = space, $[71] = t25, $[72] = type, $[73] = weight, $[74] = t26) : t26 = $[74];
  let t27;
  $[75] !== clearButtonNode || $[76] !== presentationNode || $[77] !== t26 ? (t27 = (0, import_jsx_runtime12.jsxs)(InputRoot, { children: [
    t26,
    presentationNode,
    clearButtonNode
  ] }), $[75] = clearButtonNode, $[76] = presentationNode, $[77] = t26, $[78] = t27) : t27 = $[78];
  let t28;
  return $[79] !== prefixNode || $[80] !== rootTheme.tone || $[81] !== suffixNode || $[82] !== t27 ? (t28 = (0, import_jsx_runtime12.jsxs)(StyledTextInput, { "data-ui": "TextInput", tone: rootTheme.tone, children: [
    prefixNode,
    t27,
    suffixNode
...
function useDelayedState(initialState) {
  const $ = (0, import_react_compiler_runtime.c)(3), [state, setState] = (0, import_react51.useState)(initialState), delayedAction = (0, import_react51.useRef)(void 0);
  let t0;
...
var TooltipCard = (0, import_react51.memo)((0, import_react51.forwardRef)(function(props, ref) {
  ...
  let t8;
  $[24] !== animate2 ? (t8 = animate2 ? ["hidden", "initial"] : void 0, $[24] = animate2, $[25] = t8) : t8 = $[25];
  let t9;
  $[26] !== animate2 ? (t9 = animate2 ? ["visible", "scaleIn"] : void 0, $[26] = animate2, $[27] = t9) : t9 = $[27];
  let t10;
  $[28] !== animate2 ? (t10 = animate2 ? ["hidden", "scaleOut"] : void 0, $[28] = animate2, $[29] = t10) : t10 = $[29];
  let t11;
  $[30] !== arrow22 || $[31] !== arrowRef || $[32] !== arrowStyle ? (t11 = arrow22 && (0, import_jsx_runtime12.jsx)(Arrow, { ref: arrowRef, style: arrowStyle, width: DEFAULT_TOOLTIP_ARROW_WIDTH, height: DEFAULT_TOOLTIP_ARROW_HEIGHT, radius: DEFAULT_TOOLTIP_ARROW_RADIUS }), $[30] = arrow22, $[31] = arrowRef, $[32] = arrowStyle, $[33] = t11) : t11 = $[33];
  let t12;
  return $[34] !== children || $[35] !== padding || $[36] !== placement || $[37] !== radius || $[38] !== ref || $[39] !== rootStyle2 || $[40] !== scheme || $[41] !== shadow || $[42] !== t10 || $[43] !== t11 || $[44] !== t7 || $[45] !== t8 || $[46] !== t9 ? (t12 = (0, import_jsx_runtime12.jsxs)(MotionCard, { "data-ui": "Tooltip__card", ...t7, "data-placement": placement, padding, radius, ref, scheme, shadow, style: rootStyle2, variants: POPOVER_MOTION_PROPS.card, transition: POPOVER_MOTION_PROPS.transition, initial: t8, animate: t9, exit: t10, children: [
    children,
    t11
...
function TooltipDelayGroupProvider(props) {
  ...
  const value = t0;
  let t3;
  return $[6] !== children || $[7] !== value ? (t3 = (0, import_jsx_runtime12.jsx)(TooltipDelayGroupContext.Provider, { value, children }), $[6] = children, $[7] = value, $[8] = t3) : t3 = $[8], t3;
}
TooltipDelayGroupProvider.displayName = "TooltipDelayGroupProvider";
function useTooltipDelayGroup() {
  return (0, import_react51.useContext)(TooltipDelayGroupContext);
}
var StyledTooltip = dt(Layer).withConfig({
  displayName: "StyledTooltip",
  componentId: "sc-13f2zvh-0"
})`pointer-events:none;`;
var Tooltip = (0, import_react51.forwardRef)(function(props, forwardedRef) {
  var _a, _b, _c, _d, _e;
  const boundaryElementContext = useBoundaryElement(), {
    ...
    delay: delay2,
    ...restProps
  } = props, animate2 = usePrefersReducedMotion() ? false : _animate, fallbackPlacements = useArrayProp(fallbackPlacementsProp), ref = (0, import_react51.useRef)(null), [referenceElement, setReferenceElement] = (0, import_react51.useState)(null), arrowRef = (0, import_react51.useRef)(null), rootBoundary = "viewport", [tooltipMaxWidth, setTooltipMaxWidth] = (0, import_react51.useState)(0);
  (0, import_react51.useImperativeHandle)(forwardedRef, () => ref.current);
  const portal = usePortal(), portalElement = typeof portalProp == "string" ? ((_a = portal.elements) == null ? void 0 : _a[portalProp]) || null : portal.element, middleware = (0, import_react51.useMemo)(() => {
    const ret = [];
  ...
  }, [isInsideGroup, openDelay, setIsGroupActive, setOpenTooltipId, tooltipId, closeDelay, setIsOpen]), handleBlur = (0, import_react51.useCallback)((e) => {
    var _a2, _b2;
    handleIsOpenChange(false), (_b2 = (_a2 = childProp == null ? void 0 : childProp.props) == null ? void 0 : _a2.onBlur) == null ? void 0 : _b2.call(_a2, e);
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleClick = (0, import_react51.useCallback)((e_0) => {
    var _a2, _b2;
    handleIsOpenChange(false, true), (_b2 = childProp == null ? void 0 : (_a2 = childProp.props).onClick) == null ? void 0 : _b2.call(_a2, e_0);
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleContextMenu = (0, import_react51.useCallback)((e_1) => {
    var _a2, _b2;
    handleIsOpenChange(false, true), (_b2 = childProp == null ? void 0 : (_a2 = childProp.props).onContextMenu) == null ? void 0 : _b2.call(_a2, e_1);
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleFocus = (0, import_react51.useCallback)((e_2) => {
    var _a2, _b2;
  ...
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleMouseEnter = (0, import_react51.useCallback)((e_3) => {
    var _a2, _b2;
  ...
  }, [childProp == null ? void 0 : childProp.props, handleIsOpenChange]), handleMouseLeave = (0, import_react51.useCallback)((e_4) => {
    var _a2, _b2;
  ...
  }, [disabled, handleIsOpenChange, showTooltip]), (0, import_react51.useEffect)(() => {
    !content2 && showTooltip && handleIsOpenChange(false);
  }, [content2, handleIsOpenChange, showTooltip]), (0, import_react51.useEffect)(() => {
  ...
  }, [handleIsOpenChange, showTooltip]), (0, import_react51.useLayoutEffect)(() => {
  ...
  const setArrow = (0, import_react51.useCallback)((arrowEl) => {
    arrowRef.current = arrowEl, update();
  }, [update]), setFloating = (0, import_react51.useCallback)((node) => {
    ref.current = node, refs.setFloating(node);
  }, [refs]), child = (0, import_react51.useMemo)(() => childProp ? (0, import_react51.cloneElement)(childProp, {
    onBlur: handleBlur,
    onFocus: handleFocus,
  ...
  if ((0, import_react51.useImperativeHandle)(childProp ? getElementRef(childProp) : null, () => referenceElement, [referenceElement]), !child) return (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, {});
...
function useCloseOnMouseLeave(t0) {
  ...
  let t3;
  $[7] !== isInsideGroup || $[8] !== showTooltip ? (t3 = [isInsideGroup, showTooltip], $[7] = isInsideGroup, $[8] = showTooltip, $[9] = t3) : t3 = $[9], (0, import_react51.useEffect)(t2, t3);
}
...
var Hotkeys = (0, import_react51.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(24);
...
function useMenuController(props) {
  const {
    ...
    shouldFocus,
    rootElementRef
  } = props, elementsRef = (0, import_react51.useRef)([]), [activeIndex, _setActiveIndex] = (0, import_react51.useState)(-1), activeIndexRef = (0, import_react51.useRef)(activeIndex), activeElement = (0, import_react51.useMemo)(() => elementsRef.current[activeIndex] || null, [activeIndex]), mounted = !!rootElementRef.current, setActiveIndex = (0, import_react51.useCallback)((nextActiveIndex) => {
    _setActiveIndex(nextActiveIndex), activeIndexRef.current = nextActiveIndex;
  }, []), mount = (0, import_react51.useCallback)((element, selected) => {
    if (!element) return () => {
    };
  ...
  }, [rootElementRef, setActiveIndex]), handleKeyDown = (0, import_react51.useCallback)((event) => {
    if (event.key === "Tab") {
  ...
  }, [onKeyDown, originElement, setActiveIndex]), handleItemMouseEnter = (0, import_react51.useCallback)((event_0) => {
    const element_0 = event_0.currentTarget, currentIndex_3 = elementsRef.current.indexOf(element_0);
    setActiveIndex(currentIndex_3);
  }, [setActiveIndex]), handleItemMouseLeave = (0, import_react51.useCallback)(() => {
    var _a;
...
var Menu = (0, import_react51.forwardRef)(function(props, forwardedRef) {
  ...
  const padding = t0 === void 0 ? 1 : t0, space = t1 === void 0 ? 1 : t1, shouldFocus = _shouldFocus ?? (props.focusFirst && "first" || props.focusLast && "last" || null), ref = (0, import_react51.useRef)(null);
  let t2;
  $[13] === Symbol.for("react.memo_cache_sentinel") ? (t2 = () => ref.current, $[13] = t2) : t2 = $[13], (0, import_react51.useImperativeHandle)(forwardedRef, t2);
  const {
    isTopLayer: isTopLayer2
  } = useLayer();
  let t3;
  ...
  const {
    ...
    handleKeyDown,
    mount
  } = useMenuController(t3), unregisterElementRef = (0, import_react51.useRef)(null);
  let t4;
  ...
  }, t6 = [activeIndex, onItemSelect], $[20] = activeIndex, $[21] = onItemSelect, $[22] = t5, $[23] = t6) : (t5 = $[22], t6 = $[23]), (0, import_react51.useEffect)(t5, t6);
  let t7;
  ...
  const value = t9;
  let t11;
  $[38] !== children || $[39] !== space ? (t11 = (0, import_jsx_runtime12.jsx)(Stack, { space, children }), $[38] = children, $[39] = space, $[40] = t11) : t11 = $[40];
  let t12;
  $[41] !== handleKeyDown || $[42] !== handleRefChange || $[43] !== padding || $[44] !== restProps || $[45] !== t11 ? (t12 = (0, import_jsx_runtime12.jsx)(StyledMenu, { "data-ui": "Menu", ...restProps, onKeyDown: handleKeyDown, padding, ref: handleRefChange, role: "menu", tabIndex: -1, children: t11 }), $[41] = handleKeyDown, $[42] = handleRefChange, $[43] = padding, $[44] = restProps, $[45] = t11, $[46] = t12) : t12 = $[46];
  let t13;
  return $[47] !== t12 || $[48] !== value ? (t13 = (0, import_jsx_runtime12.jsx)(MenuContext.Provider, { value, children: t12 }), $[47] = t12, $[48] = value, $[49] = t13) : t13 = $[49], t13;
});
...
function useMenu() {
  const value = (0, import_react51.useContext)(MenuContext);
  if (!value)
...
function MenuGroup(props) {
  ...
  const as = t0 === void 0 ? "button" : t0, fontSize2 = t1 === void 0 ? 1 : t1, padding = t2 === void 0 ? 3 : t2, radius = t3 === void 0 ? 2 : t3, space = t4 === void 0 ? 3 : t4, tone = t5 === void 0 ? "default" : t5, menu = useMenu(), {
    ...
    registerElement
  } = menu, onItemMouseEnter = _onItemMouseEnter ?? menu.onMouseEnter, [rootElement, setRootElement] = (0, import_react51.useState)(null), [open, setOpen] = (0, import_react51.useState)(false), [shouldFocus, setShouldFocus] = (0, import_react51.useState)(null), active = !!activeElement && activeElement === rootElement, [withinMenu, setWithinMenu] = (0, import_react51.useState)(false);
  let t6;
  ...
  let t11, t12;
  $[23] !== mount || $[24] !== rootElement ? (t11 = () => mount(rootElement), t12 = [mount, rootElement], $[23] = mount, $[24] = rootElement, $[25] = t11, $[26] = t12) : (t11 = $[25], t12 = $[26]), (0, import_react51.useEffect)(t11, t12);
  let t13, t14;
  $[27] !== active ? (t13 = () => {
    active || setOpen(false);
  }, t14 = [active], $[27] = active, $[28] = t13, $[29] = t14) : (t13 = $[28], t14 = $[29]), (0, import_react51.useEffect)(t13, t14);
  let t15, t16;
  $[30] !== open ? (t15 = () => {
    open || setWithinMenu(false);
  }, t16 = [open], $[30] = open, $[31] = t15, $[32] = t16) : (t15 = $[31], t16 = $[32]), (0, import_react51.useEffect)(t15, t16);
  let t17, t18;
  $[33] !== shouldFocus ? (t17 = () => {
    if (!shouldFocus)
      return;
    ...
    return () => cancelAnimationFrame(rafId);
  }, t18 = [shouldFocus], $[33] = shouldFocus, $[34] = t17, $[35] = t18) : (t17 = $[34], t18 = $[35]), (0, import_react51.useEffect)(t17, t18);
  let t19;
...
var MenuItem = (0, import_react51.forwardRef)(function(props, forwardedRef) {
  ...
  } = menu, onItemMouseEnter = _onItemMouseEnter ?? menu.onMouseEnter, onItemMouseLeave = _onItemMouseLeave ?? menu.onMouseLeave, [rootElement, setRootElement] = (0, import_react51.useState)(null), active = !!activeElement && activeElement === rootElement, ref = (0, import_react51.useRef)(null);
  let t6;
  $[23] === Symbol.for("react.memo_cache_sentinel") ? (t6 = () => ref.current, $[23] = t6) : t6 = $[23], (0, import_react51.useImperativeHandle)(forwardedRef, t6);
  let t7, t8;
  $[24] !== mount || $[25] !== rootElement || $[26] !== selectedProp ? (t7 = () => mount(rootElement, selectedProp), t8 = [mount, rootElement, selectedProp], $[24] = mount, $[25] = rootElement, $[26] = selectedProp, $[27] = t7, $[28] = t8) : (t7 = $[27], t8 = $[28]), (0, import_react51.useEffect)(t7, t8);
  let t9;
  ...
  let t22;
  $[44] !== IconComponent || $[45] !== IconRightComponent || $[46] !== fontSize2 || $[47] !== hotkeys || $[48] !== hotkeysFontSize || $[49] !== paddingProps || $[50] !== space || $[51] !== text ? (t22 = (IconComponent || text || IconRightComponent) && (0, import_jsx_runtime12.jsxs)(Flex, { as: "span", gap: space, align: "center", ...paddingProps, children: [
    IconComponent && (0, import_jsx_runtime12.jsxs)(Text, { size: fontSize2, children: [
      (0, import_react51.isValidElement)(IconComponent) && IconComponent,
      (0, import_react_is.isValidElementType)(IconComponent) && (0, import_jsx_runtime12.jsx)(IconComponent, {})
    ] }),
  ...
  let t23;
  $[53] !== children || $[54] !== paddingProps ? (t23 = children && (0, import_jsx_runtime12.jsx)(Box, { as: "span", ...paddingProps, children }), $[53] = children, $[54] = paddingProps, $[55] = t23) : t23 = $[55];
  let t24;
  return $[56] !== as || $[57] !== disabled || $[58] !== handleClick || $[59] !== onItemMouseEnter || $[60] !== onItemMouseLeave || $[61] !== restProps || $[62] !== scheme || $[63] !== t15 || $[64] !== t16 || $[65] !== t17 || $[66] !== t18 || $[67] !== t19 || $[68] !== t20 || $[69] !== t21 || $[70] !== t22 || $[71] !== t23 ? (t24 = (0, import_jsx_runtime12.jsxs)(Selectable, { "data-ui": "MenuItem", role: "menuitem", ...restProps, "data-pressed": t15, "data-selected": t16, "data-disabled": t17, forwardedAs: as, $radius: t18, $padding: t19, $tone: t20, $scheme: scheme, disabled, onClick: handleClick, onMouseEnter: onItemMouseEnter, onMouseLeave: onItemMouseLeave, ref: setRef, tabIndex: -1, type: t21, children: [
    t22,
    t23
...
var Tab = (0, import_react51.forwardRef)(function(props, forwardedRef) {
  ...
  const fontSize2 = t0 === void 0 ? 1 : t0, padding = t1 === void 0 ? 2 : t1, ref = (0, import_react51.useRef)(null), focusedRef = (0, import_react51.useRef)(false);
  let t2;
  $[11] === Symbol.for("react.memo_cache_sentinel") ? (t2 = () => ref.current, $[11] = t2) : t2 = $[11], (0, import_react51.useImperativeHandle)(forwardedRef, t2);
  let t3;
  ...
  }, t6 = [focused], $[15] = focused, $[16] = t5, $[17] = t6) : (t5 = $[16], t6 = $[17]), (0, import_react51.useEffect)(t5, t6);
...
var TabList = (0, import_react51.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(15);
  ...
  if ($[3] !== childrenProp || $[4] !== focusedIndex) {
    const children = import_react51.Children.toArray(childrenProp).filter(import_react51.isValidElement);
    let t12;
    $[6] !== focusedIndex ? (t12 = (child, childIndex) => (0, import_react51.cloneElement)(child, {
...
function useClickOutside(listener, t0, boundaryElement) {
  const $ = (0, import_react_compiler_runtime2.c)(12), elementsArg = t0 === void 0 ? EMPTY_ARRAY : t0, [element, setElement] = (0, import_react52.useState)(null);
  let t1;
  $[0] !== element || $[1] !== elementsArg ? (t1 = () => _getElements(element, elementsArg), $[0] = element, $[1] = elementsArg, $[2] = t1) : t1 = $[2];
  const [elements, setElements] = (0, import_react52.useState)(t1), elementsRef = (0, import_react52.useRef)(elements);
  let t2, t3;
  ...
  }, t3 = [element, elementsArg], $[3] = element, $[4] = elementsArg, $[5] = t2, $[6] = t3) : (t2 = $[5], t3 = $[6]), (0, import_react52.useEffect)(t2, t3);
  let t4, t5;
  ...
  }, t5 = [boundaryElement, listener, elements], $[7] = boundaryElement, $[8] = elements, $[9] = listener, $[10] = t4, $[11] = t5) : (t4 = $[10], t5 = $[11]), (0, import_react52.useEffect)(t4, t5), setElement;
}
...
function useForwardedRef(ref) {
  const $ = (0, import_react_compiler_runtime2.c)(1), innerRef = (0, import_react52.useRef)(null);
  let t0;
  return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => innerRef.current, $[0] = t0) : t0 = $[0], (0, import_react52.useImperativeHandle)(ref, t0), innerRef;
}
var ErrorBoundary = class extends import_react52.Component {
  constructor() {
    super(...arguments);
...
var InnerAutocomplete = (0, import_react52.forwardRef)(function(props, forwardedRef) {
  const {
    border: border2 = true,
    customValidity,
    disabled,
    ...
    value: valueProp,
    ...restProps
  } = props, [state, dispatch] = (0, import_react52.useReducer)(autocompleteReducer, {
    ...
    query,
    value
  } = state, defaultRenderOption = (0, import_react52.useCallback)(({
    value: value_0
  }) => (0, import_jsx_runtime13.jsx)(Card, { "data-as": "button", padding: paddingProp, radius: 2, tone: "inherit", children: (0, import_jsx_runtime13.jsx)(Text, { size: fontSize2, textOverflow: "ellipsis", children: value_0 }) }), [fontSize2, paddingProp]), renderOption = typeof renderOptionProp == "function" ? renderOptionProp : defaultRenderOption, filterOption = typeof filterOptionProp == "function" ? filterOptionProp : DEFAULT_FILTER_OPTION, rootElementRef = (0, import_react52.useRef)(null), resultsPopoverElementRef = (0, import_react52.useRef)(null), inputElementRef = (0, import_react52.useRef)(null), listBoxElementRef = (0, import_react52.useRef)(null), listFocusedRef = (0, import_react52.useRef)(false), valueRef = (0, import_react52.useRef)(value), valuePropRef = (0, import_react52.useRef)(valueProp), popoverMouseWithinRef = (0, import_react52.useRef)(false);
  (0, import_react52.useImperativeHandle)(forwardedRef, () => inputElementRef.current);
  const listBoxId = `${id3}-listbox`, options = Array.isArray(optionsProp) ? optionsProp : EMPTY_ARRAY, padding = useArrayProp(paddingProp), currentOption = (0, import_react52.useMemo)(() => value !== null ? options.find((o) => o.value === value) : void 0, [options, value]), filteredOptions = (0, import_react52.useMemo)(() => options.filter((option) => query ? filterOption(query, option) : true), [filterOption, options, query]), filteredOptionsLen = filteredOptions.length, activeItemId = activeValue ? `${id3}-option-${activeValue}` : void 0, expanded = query !== null && loading || focused && query !== null, handleRootBlur = (0, import_react52.useCallback)((event) => {
    setTimeout(() => {
  ...
  }, [onBlur, onQueryChange, relatedElements]), handleRootFocus = (0, import_react52.useCallback)((event_0) => {
  ...
  }, []), handleOptionSelect = (0, import_react52.useCallback)((v) => {
    var _a;
    dispatch({
      type: "value/change",
      value: v
  ...
  }, [onChange, onSelect, onQueryChange]), handleRootKeyDown = (0, import_react52.useCallback)((event_1) => {
    var _a, _b;
  ...
  }, [activeValue, filteredOptions, filteredOptionsLen, onQueryChange]), handleInputChange = (0, import_react52.useCallback)((event_2) => {
    const nextQuery = event_2.currentTarget.value;
    dispatch({
      type: "input/change",
      query: nextQuery
    }), onQueryChange && onQueryChange(nextQuery);
  }, [onQueryChange]), dispatchOpen = (0, import_react52.useCallback)(() => {
    dispatch({
      type: "root/open",
      query: value ? renderValue(value, currentOption) : ""
    });
  }, [currentOption, renderValue, value]), handleInputFocus = (0, import_react52.useCallback)((event_3) => {
    focused || (dispatch({
      type: "input/focus"
    }), onFocus && onFocus(event_3), openOnFocus && dispatchOpen());
  }, [focused, onFocus, openOnFocus, dispatchOpen]), handlePopoverMouseEnter = (0, import_react52.useCallback)(() => {
    popoverMouseWithinRef.current = true;
  }, []), handlePopoverMouseLeave = (0, import_react52.useCallback)(() => {
    popoverMouseWithinRef.current = false;
  }, []), handleClearButtonClick = (0, import_react52.useCallback)(() => {
    var _a;
    dispatch({
      type: "root/clear"
    }), valueRef.current = "", onChange && onChange(""), onQueryChange && onQueryChange(null), (_a = inputElementRef.current) == null ? void 0 : _a.focus();
  }, [onChange, onQueryChange]), handleClearButtonFocus = (0, import_react52.useCallback)(() => {
    dispatch({
      type: "input/focus"
    });
  }, []);
  ...
  }, [valueProp]), (0, import_react52.useEffect)(() => {
    !focused && valueRef.current && dispatch({
      type: "root/setActiveValue",
      value: valueRef.current
    });
  }, [focused]), (0, import_react52.useEffect)(() => {
  ...
  const clearButton = (0, import_react52.useMemo)(() => {
    if (!loading && !disabled && value)
      return {
        "aria-label": "Clear",
        onFocus: handleClearButtonFocus
      };
  }, [disabled, handleClearButtonFocus, loading, value]), openButtonBoxPadding = (0, import_react52.useMemo)(() => padding.map((v_0) => v_0 === 0 ? 0 : v_0 === 1 || v_0 === 2 ? 1 : v_0 - 2), [padding]), openButtonPadding = (0, import_react52.useMemo)(() => padding.map((v_1) => Math.max(v_1 - 1, 0)), [padding]), openButtonProps = (0, import_react52.useMemo)(() => typeof openButton == "object" ? openButton : EMPTY_RECORD, [openButton]), handleOpenClick = (0, import_react52.useCallback)((event_4) => {
  ...
  }, [openButtonProps, dispatchOpen]), openButtonNode = (0, import_react52.useMemo)(() => !disabled && !readOnly && openButton ? (0, import_jsx_runtime13.jsx)(Box, { "aria-hidden": expanded, padding: openButtonBoxPadding, children: (0, import_jsx_runtime13.jsx)(Button, { "aria-label": "Open", disabled: expanded, fontSize: fontSize2, icon: ChevronDownIcon, mode: "bleed", padding: openButtonPadding, ...openButtonProps, onClick: handleOpenClick }) }) : void 0, [disabled, expanded, fontSize2, handleOpenClick, openButton, openButtonBoxPadding, openButtonPadding, openButtonProps, readOnly]), inputValue = (0, import_react52.useMemo)(() => query === null ? value !== null ? renderValue(value, currentOption) : "" : query, [currentOption, query, renderValue, value]), input = (0, import_jsx_runtime13.jsx)(TextInput, { ...restProps, "aria-activedescendant": activeItemId, "aria-autocomplete": "list", "aria-expanded": expanded, "aria-owns": listBoxId, autoCapitalize: "off", autoComplete: "off", autoCorrect: "off", border: border2, clearButton, customValidity, disabled, fontSize: fontSize2, icon, iconRight: loading && AnimatedSpinnerIcon, id: id3, inputMode: "search", onChange: handleInputChange, onClear: handleClearButtonClick, onFocus: handleInputFocus, padding, prefix, radius, readOnly, ref: inputElementRef, role: "combobox", spellCheck: false, suffix: suffix || openButtonNode, value: inputValue }), handleListBoxKeyDown = (0, import_react52.useCallback)((event_5) => {
    var _a;
    event_5.key === "Tab" && listFocused && ((_a = inputElementRef.current) == null ? void 0 : _a.focus());
  }, [listFocused]), content2 = (0, import_react52.useMemo)(() => filteredOptions.length === 0 ? null : (0, import_jsx_runtime13.jsx)(ListBox, { "data-ui": "AutoComplete__results", onKeyDown: handleListBoxKeyDown, padding: 1, ...listBox, tabIndex: -1, children: (0, import_jsx_runtime13.jsx)(Stack, { as: "ul", "aria-multiselectable": false, "data-ui": "AutoComplete__resultsList", id: listBoxId, ref: listBoxElementRef, role: "listbox", space: 1, children: filteredOptions.map((option_0) => {
    const active = activeValue !== null ? option_0.value === activeValue : currentOption === option_0;
    return (0, import_jsx_runtime13.jsx)(AutocompleteOption, { id: `${id3}-option-${option_0.value}`, onSelect: handleOptionSelect, selected: active, value: option_0.value, children: (0, import_react52.cloneElement)(renderOption(option_0), {
      disabled: loading,
      selected: active,
      tabIndex: listFocused && active ? 0 : -1
    }) }, option_0.value);
  }) }) }), [activeValue, currentOption, filteredOptions, handleOptionSelect, handleListBoxKeyDown, id3, listBox, listBoxId, listFocused, loading, renderOption]), results = (0, import_react52.useMemo)(() => renderPopover ? renderPopover({
    content: content2,
    hidden: !expanded,
...
var Breadcrumbs = (0, import_react52.forwardRef)(function(props, ref) {
  const {
    children,
    maxLength,
    separator,
    space: spaceRaw = 2,
    ...restProps
  } = props, space = useArrayProp(spaceRaw), [open, setOpen] = (0, import_react52.useState)(false), expandElementRef = (0, import_react52.useRef)(null), popoverElementRef = (0, import_react52.useRef)(null), collapse = (0, import_react52.useCallback)(() => setOpen(false), []), expand = (0, import_react52.useCallback)(() => setOpen(true), []);
  useClickOutsideEvent(collapse, () => [expandElementRef.current, popoverElementRef.current]);
  const rawItems = (0, import_react52.useMemo)(() => import_react52.Children.toArray(children).filter(import_react52.isValidElement), [children]), items = (0, import_react52.useMemo)(() => {
  ...
  return (0, import_jsx_runtime13.jsx)(StyledBreadcrumbs, { "data-ui": "Breadcrumbs", ...restProps, ref, children: items.map((item, itemIndex) => (0, import_jsx_runtime13.jsxs)(import_react52.Fragment, { children: [
...
function useDialog() {
  return (0, import_react52.useContext)(DialogContext);
}
...
var DialogCard = (0, import_react52.forwardRef)(function(props, forwardedRef) {
  var _a;
  const $ = (0, import_react_compiler_runtime2.c)(38), {
    ...
    shadow: shadowProp,
    width: widthProp
  } = props, portal = usePortal(), portalElement = portalProp ? ((_a = portal.elements) == null ? void 0 : _a[portalProp]) || null : portal.element, boundaryElement = useBoundaryElement().element, radius = useArrayProp(radiusProp), shadow = useArrayProp(shadowProp), width = useArrayProp(widthProp), ref = (0, import_react52.useRef)(null), contentRef = (0, import_react52.useRef)(null), layer = useLayer(), {
    isTopLayer: isTopLayer2
  } = layer, labelId = `${id3}_label`, showCloseButton = !!onClose && hideCloseButton === false, showHeader = !!header || showCloseButton;
  let t0;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = () => ref.current, $[0] = t0) : t0 = $[0], (0, import_react52.useImperativeHandle)(forwardedRef, t0);
  let t1;
  $[1] === Symbol.for("react.memo_cache_sentinel") ? (t1 = () => contentRef.current, $[1] = t1) : t1 = $[1], (0, import_react52.useImperativeHandle)(forwardedContentRef, t1);
  let t2, t3;
  $[2] !== autoFocus ? (t2 = () => {
    autoFocus && ref.current && focusFirstDescendant(ref.current);
  }, t3 = [autoFocus, ref], $[2] = autoFocus, $[3] = t2, $[4] = t3) : (t2 = $[3], t3 = $[4]), (0, import_react52.useEffect)(t2, t3);
  let t4;
  $[5] !== boundaryElement || $[6] !== isTopLayer2 || $[7] !== onClose || $[8] !== portalElement ? (t4 = (event) => {
    if (!isTopLayer2 || !onClose)
      return;
    const target = document.activeElement;
    target && !isTargetWithinScope(boundaryElement, portalElement, target) || event.key === "Escape" && (event.preventDefault(), event.stopPropagation(), onClose());
  }, $[5] = boundaryElement, $[6] = isTopLayer2, $[7] = onClose, $[8] = portalElement, $[9] = t4) : t4 = $[9], useGlobalKeyDown(t4);
  let t5;
  $[10] !== boundaryElement || $[11] !== isTopLayer2 || $[12] !== onClickOutside || $[13] !== portalElement ? (t5 = isTopLayer2 && onClickOutside && ((event_0) => {
    const target_0 = event_0.target;
    target_0 && !isTargetWithinScope(boundaryElement, portalElement, target_0) || onClickOutside();
  }), $[10] = boundaryElement, $[11] = isTopLayer2, $[12] = onClickOutside, $[13] = portalElement, $[14] = t5) : t5 = $[14];
  let t6;
...
var Dialog = (0, import_react52.forwardRef)(function(props, ref) {
  var _a;
  ...
  const handleFocus = t7, labelId = `${id3}_label`, rootClickTimeoutRef = (0, import_react52.useRef)(void 0);
  let t8;
...
function DialogProvider(props) {
  ...
  let t2;
  return $[3] !== children || $[4] !== contextValue ? (t2 = (0, import_jsx_runtime13.jsx)(DialogContext.Provider, { value: contextValue, children }), $[3] = children, $[4] = contextValue, $[5] = t2) : t2 = $[5], t2;
}
DialogProvider.displayName = "DialogProvider";
var MenuButton = (0, import_react52.forwardRef)(function(props, forwardedRef) {
  ...
  } = props, disableRestoreFocusOnClose = t0 === void 0 ? false : t0, deprecated_portal = t1 === void 0 ? true : t1, [open, setOpen] = (0, import_react52.useState)(false), [shouldFocus, setShouldFocus] = (0, import_react52.useState)(null), [buttonElement, setButtonElement] = (0, import_react52.useState)(null);
  let t2;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t2 = [], $[0] = t2) : t2 = $[0];
  const [menuElements, setChildMenuElements] = (0, import_react52.useState)(t2), openRef = (0, import_react52.useRef)(open);
  let t3, t4;
  $[1] !== onOpen || $[2] !== open ? (t3 = () => {
    onOpen && open && !openRef.current && onOpen();
  }, t4 = [onOpen, open], $[1] = onOpen, $[2] = open, $[3] = t3, $[4] = t4) : (t3 = $[3], t4 = $[4]), (0, import_react52.useEffect)(t3, t4);
  let t5, t6;
  $[5] !== onClose || $[6] !== open ? (t5 = () => {
    onClose && !open && openRef.current && onClose();
  }, t6 = [onClose, open], $[5] = onClose, $[6] = open, $[7] = t5, $[8] = t6) : (t5 = $[7], t6 = $[8]), (0, import_react52.useEffect)(t5, t6);
  let t7, t8;
  $[9] !== open ? (t7 = () => {
    openRef.current = open;
  }, t8 = [open], $[9] = open, $[10] = t7, $[11] = t8) : (t7 = $[10], t8 = $[11]), (0, import_react52.useEffect)(t7, t8);
  let t9;
  ...
  let t17;
  $[28] !== buttonElement || $[29] !== handleBlur || $[30] !== handleItemClick || $[31] !== handleMenuClickOutside || $[32] !== handleMenuEscape || $[33] !== id3 || $[34] !== menuProp || $[35] !== shouldFocus ? (t17 = menuProp && (0, import_react52.cloneElement)(menuProp, {
    "aria-labelledby": id3,
  ...
  const menu = t17;
  let t18, t19;
  $[37] !== buttonProp || $[38] !== handleMouseDown || $[39] !== id3 || $[40] !== open ? (t19 = buttonProp && (0, import_react52.cloneElement)(buttonProp, {
    "data-ui": "MenuButton",
    id: id3,
  ...
  }), $[37] = buttonProp, $[38] = handleMouseDown, $[39] = id3, $[40] = open, $[41] = t19) : t19 = $[41], t18 = t19;
  const button = t18;
  let t20, t21;
  $[42] !== buttonElement ? (t20 = () => buttonElement, t21 = [buttonElement], $[42] = buttonElement, $[43] = t20, $[44] = t21) : (t20 = $[43], t21 = $[44]), (0, import_react52.useImperativeHandle)(forwardedRef, t20, t21);
  let t22, t23;
  ...
  let t25;
  $[55] !== button ? (t25 = button || (0, import_jsx_runtime13.jsx)(import_jsx_runtime13.Fragment, {}), $[55] = button, $[56] = t25) : t25 = $[56];
  let t26;
  return $[57] !== menu || $[58] !== open || $[59] !== popoverProps || $[60] !== t25 ? (t26 = (0, import_jsx_runtime13.jsx)(Popover, { "data-ui": "MenuButton__popover", ...popoverProps, content: menu, open, children: t25 }), $[57] = menu, $[58] = open, $[59] = popoverProps, $[60] = t25, $[61] = t26) : t26 = $[61], t26;
});
...
var Skeleton = (0, import_react52.forwardRef)(function(props, ref) {
  ...
  const animated = t0 === void 0 ? false : t0, [visible, setVisible] = (0, import_react52.useState)(!delay2);
  let t1, t2;
  $[5] !== delay2 ? (t1 = () => {
    if (!delay2)
  ...
  }, t2 = [delay2], $[5] = delay2, $[6] = t1, $[7] = t2) : (t1 = $[6], t2 = $[7]), (0, import_react52.useEffect)(t1, t2);
...
var TextSkeleton = (0, import_react52.forwardRef)(function(props, ref) {
...
var LabelSkeleton = (0, import_react52.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime2.c)(7);
  let restProps, t0;
  $[0] !== props ? ({
    size: t0,
...
var HeadingSkeleton = (0, import_react52.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime2.c)(7);
  let restProps, t0;
  $[0] !== props ? ({
    size: t0,
...
var CodeSkeleton = (0, import_react52.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime2.c)(7);
  let restProps, t0;
  $[0] !== props ? ({
    size: t0,
...
var TabPanel = (0, import_react52.forwardRef)(function(props, ref) {
...
function useMounted() {
  return (0, import_react52.useSyncExternalStore)(subscribe, _temp$12, _temp22);
}
function _temp22() {
  return false;
}
...
function ToastProvider(props) {
  ...
  const [state, setState] = (0, import_react52.useState)(t1), mounted = useMounted();
  let t2, t3;
  $[1] === Symbol.for("react.memo_cache_sentinel") ? (t3 = {
    version: 0,
    push: (params) => {
      const id3 = params.id || generateToastId(), duration = params.duration || 5e3;
      return (0, import_react52.startTransition)(() => {
        setState((prevState) => {
          if (duration === 0.01)
            return prevState.filter((toast) => toast.id !== id3);
          const dismiss = () => (0, import_react52.startTransition)(() => setState((currentState) => currentState.filter((toast_0) => toast_0.id !== id3)));
  ...
  const value = t2;
  let t4;
  $[2] !== gap || $[3] !== mounted || $[4] !== padding || $[5] !== paddingX || $[6] !== paddingY || $[7] !== state || $[8] !== zOffset ? (t4 = mounted && (0, import_jsx_runtime13.jsx)(LayerProvider, { zOffset, children: (0, import_jsx_runtime13.jsx)(ToastLayer, { padding, paddingX, paddingY, gap, children: (0, import_jsx_runtime13.jsx)(AnimatePresence, { initial: false, mode: "popLayout", children: state.map(_temp4) }) }) }), $[2] = gap, $[3] = mounted, $[4] = padding, $[5] = paddingX, $[6] = paddingY, $[7] = state, $[8] = zOffset, $[9] = t4) : t4 = $[9];
  let t5;
  return $[10] !== children || $[11] !== t4 ? (t5 = (0, import_jsx_runtime13.jsxs)(ToastContext.Provider, { value, children: [
    children,
    t4
...
function useToast() {
  const value = (0, import_react52.useContext)(ToastContext);
  if (!value)
...
var Tree = (0, import_react52.memo)((0, import_react52.forwardRef)(function(props, forwardedRef) {
  ...
  const space = t0 === void 0 ? 1 : t0, ref = (0, import_react52.useRef)(null), [focusedElement, setFocusedElement] = (0, import_react52.useState)(null), focusedElementRef = (0, import_react52.useRef)(focusedElement);
  let t1, t2;
  $[5] === Symbol.for("react.memo_cache_sentinel") ? (t2 = [], $[5] = t2) : t2 = $[5], t1 = t2;
  const path = t1;
  let t3;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t3 = [], $[6] = t3) : t3 = $[6];
  const [itemElements, setItemElements] = (0, import_react52.useState)(t3);
  let t4;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t4 = {}, $[7] = t4) : t4 = $[7];
  const [state, setState] = (0, import_react52.useState)(t4), stateRef = (0, import_react52.useRef)(state);
  let t5;
  $[8] === Symbol.for("react.memo_cache_sentinel") ? (t5 = () => ref.current, $[8] = t5) : t5 = $[8], (0, import_react52.useImperativeHandle)(forwardedRef, t5);
  let t6, t7;
  $[9] !== focusedElement ? (t6 = () => {
    focusedElementRef.current = focusedElement;
  }, t7 = [focusedElement], $[9] = focusedElement, $[10] = t6, $[11] = t7) : (t6 = $[10], t7 = $[11]), (0, import_react52.useEffect)(t6, t7);
  let t8, t9;
  $[12] !== state ? (t8 = () => {
    stateRef.current = state;
  }, t9 = [state], $[12] = state, $[13] = t8, $[14] = t9) : (t8 = $[13], t9 = $[14]), (0, import_react52.useEffect)(t8, t9);
  let t10;
  ...
  let t18;
  $[26] !== children ? (t18 = [children], $[26] = children, $[27] = t18) : t18 = $[27], (0, import_react52.useEffect)(t17, t18);
  let t19;
  $[28] !== children || $[29] !== handleFocus || $[30] !== handleKeyDown || $[31] !== restProps || $[32] !== space ? (t19 = (0, import_jsx_runtime13.jsx)(Stack, { as: "ul", "data-ui": "Tree", ...restProps, onFocus: handleFocus, onKeyDown: handleKeyDown, ref, role: "tree", space, children }), $[28] = children, $[29] = handleFocus, $[30] = handleKeyDown, $[31] = restProps, $[32] = space, $[33] = t19) : t19 = $[33];
  let t20;
  return $[34] !== contextValue || $[35] !== t19 ? (t20 = (0, import_jsx_runtime13.jsx)(TreeContext.Provider, { value: contextValue, children: t19 }), $[34] = contextValue, $[35] = t19, $[36] = t20) : t20 = $[36], t20;
}));
...
function useTree() {
  const tree = (0, import_react52.useContext)(TreeContext);
  if (!tree)
    throw new Error("Tree: missing context value");
  return tree;
}
var TreeGroup = (0, import_react52.memo)(function(props) {
  const $ = (0, import_react_compiler_runtime2.c)(9);
  let children, restProps, t0;
  $[0] !== props ? ({
    children,
...
var StyledTreeItem = (0, import_react52.memo)(dt.li.withConfig({
...
var TreeItem = (0, import_react52.memo)(function(props) {
  const {
    children,
    ...
    weight,
    ...restProps
  } = props, rootRef = (0, import_react52.useRef)(null), treeitemRef = (0, import_react52.useRef)(null), tree = useTree(), {
    path,
    registerItem,
    setExpanded,
    setFocusedElement
  } = tree, _id = (0, import_react52.useId)(), id3 = idProp || _id, itemPath = (0, import_react52.useMemo)(() => path.concat([id3 || ""]), [id3, path]), itemKey = itemPath.join("/"), itemState = tree.state[itemKey], focused = tree.focusedElement === rootRef.current, expanded = (itemState == null ? void 0 : itemState.expanded) === void 0 ? expandedProp : (itemState == null ? void 0 : itemState.expanded) || false, tabIndex = tree.focusedElement && tree.focusedElement === rootRef.current ? 0 : -1, contextValue = (0, import_react52.useMemo)(() => ({
    ...tree,
    level: tree.level + 1,
    path: itemPath
  }), [itemPath, tree]), handleClick = (0, import_react52.useCallback)((event) => {
  ...
  }, [expanded, itemKey, onClick, setExpanded, setFocusedElement]), handleKeyDown = (0, import_react52.useCallback)((event_0) => {
    var _a;
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-AN4W7KWB.js.map
