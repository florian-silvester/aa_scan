...
function ruleset(value, root, parent, index2, offset, rules, points, type, props, children, length2) {
  ...
  for (var i3 = 0, j3 = 0, k2 = 0; i3 < index2; ++i3)
    for (var x3 = 0, y2 = substr(value, post + 1, post = abs(j3 = points[i3])), z2 = value; x3 < size; ++x3)
      if (z2 = trim(j3 > 0 ? rule[x3] + " " + y2 : replace(y2, /&\f/g, rule[x3])))
        props[k2++] = z2;
...
function _(...t3) {
  ...
  return t3.forEach((s3, i3) => {
    ...
    K(s3, (c2) => {
      const a2 = n3;
      n3 = n3 | l2, e2[i3] = c2, a2 !== r3 && n3 === r3 && o3 && (o3(), o3 = null);
    });
  }), (s3) => (i3) => {
    const l2 = () => {
      s3([i3].concat(e2));
...
function po(...t3) {
  return (e2) => t3.reduceRight(mo, e2);
}
function ho(t3) {
  let e2, n3;
...
function rt(...t3) {
  ...
  return t3.forEach((s3, i3) => {
    const l2 = Math.pow(2, i3);
    K(s3, (c2) => {
      n3[i3] = c2, o3 = o3 | l2, o3 === r3 && G(e2, n3);
    });
  }), function(s3, i3) {
    switch (s3) {
      case qt: {
  ...
  return function(e2, n3) {
    switch (e2) {
      case qt:
        return;
      case zt:
        return fo(...t3.map((o3) => K(o3, n3)));
    }
  };
}
var mt = ((t3) => (t3[t3.DEBUG = 0] = "DEBUG", t3[t3.INFO = 1] = "INFO", t3[t3.WARN = 2] = "WARN", t3[t3.ERROR = 3] = "ERROR", t3))(mt || {});
var So = {
  0: "debug",
  3: "error",
  1: "log",
...
var Vt = U(
  () => {
    ...
    return {
      log: C((n3, o3, r3 = 1) => {
        var i3;
        const s3 = (i3 = xo().VIRTUOSO_LOG_LEVEL) != null ? i3 : st(t3);
        r3 >= s3 && console[So[r3]](
...
function Ht(t3, e2, n3) {
  return Ge(t3, e2, n3).callbackRef;
}
...
function On(t3, e2, n3, o3, r3, s3, i3, l2, c2) {
  const a2 = import_react10.default.useCallback(
    (p2) => {
      const S3 = To(p2.children, e2, l2 ? "offsetWidth" : "offsetHeight", r3);
      let g2 = p2.parentElement;
      for (; !g2.dataset.virtuosoScroller; )
        g2 = g2.parentElement;
      const h2 = g2.lastElementChild.dataset.viewportType === "window";
      let w3;
      h2 && (w3 = g2.ownerDocument.defaultView);
      const v2 = i3 ? l2 ? i3.scrollLeft : i3.scrollTop : h2 ? l2 ? w3.scrollX || w3.document.documentElement.scrollLeft : w3.scrollY || w3.document.documentElement.scrollTop : l2 ? g2.scrollLeft : g2.scrollTop, m2 = i3 ? l2 ? i3.scrollWidth : i3.scrollHeight : h2 ? l2 ? w3.document.documentElement.scrollWidth : w3.document.documentElement.scrollHeight : l2 ? g2.scrollWidth : g2.scrollHeight, d2 = i3 ? l2 ? i3.offsetWidth : i3.offsetHeight : h2 ? l2 ? w3.innerWidth : w3.innerHeight : l2 ? g2.offsetWidth : g2.offsetHeight;
      o3({
        scrollHeight: m2,
        scrollTop: Math.max(v2, 0),
        viewportHeight: d2
      }), s3 == null || s3(
        l2 ? fn("column-gap", getComputedStyle(p2).columnGap, r3) : fn("row-gap", getComputedStyle(p2).rowGap, r3)
      ), S3 !== null && t3(S3);
    },
...
function To(t3, e2, n3, o3) {
  ...
  for (let i3 = 0; i3 < r3; i3++) {
    ...
    if (l2.dataset.index === void 0)
      continue;
    const c2 = parseInt(l2.dataset.index), a2 = parseFloat(l2.dataset.knownSize), p2 = e2(l2, n3);
    if (p2 === 0 && o3("Zero-sized element, this should not happen", { child: l2 }, mt.ERROR), p2 === a2)
      continue;
    const S3 = s3[s3.length - 1];
    s3.length === 0 || S3.size !== p2 || S3.endIndex !== c2 - 1 ? s3.push({ endIndex: c2, size: p2, startIndex: c2 }) : s3[s3.length - 1].endIndex++;
  }
  return s3;
}
function fn(t3, e2, n3) {
  return e2 !== "normal" && !(e2 != null && e2.endsWith("px")) && n3(`${t3} was not resolved to pixel value correctly`, e2, mt.WARN), e2 === "normal" ? 0 : parseInt(e2 != null ? e2 : "0", 10);
}
function _e(t3, e2, n3) {
  const o3 = import_react10.default.useRef(null), r3 = import_react10.default.useCallback(
    (c2) => {
      if (!(c2 != null && c2.offsetParent))
        return;
      const a2 = c2.getBoundingClientRect(), p2 = a2.width;
      let S3, g2;
      if (e2) {
        const h2 = e2.getBoundingClientRect(), w3 = a2.top - h2.top;
        g2 = h2.height - Math.max(0, w3), S3 = w3 + e2.scrollTop;
      } else {
        const h2 = i3.current.ownerDocument.defaultView;
        g2 = h2.innerHeight - Math.max(0, a2.top), S3 = a2.top + h2.scrollY;
      }
      o3.current = {
        offsetTop: S3,
        visibleHeight: g2,
    ...
    [t3, e2]
  ), { callbackRef: s3, ref: i3 } = Ge(r3, true, n3), l2 = import_react10.default.useCallback(() => {
    r3(i3.current);
  }, [r3, i3]);
  return import_react10.default.useEffect(() => {
    ...
    if (e2) {
      ...
      const a2 = (c2 = i3.current) == null ? void 0 : c2.ownerDocument.defaultView;
...
var at = U(
  () => {
    const t3 = $(), e2 = $(), n3 = C(0), o3 = $(), r3 = C(0), s3 = $(), i3 = $(), l2 = C(0), c2 = C(0), a2 = C(0), p2 = C(0), S3 = $(), g2 = $(), h2 = C(false), w3 = C(false), v2 = C(false);
    return O(
      x(
        t3,
        E(({ scrollTop: m2 }) => m2)
...
function pt(t3, e2, n3) {
  return j(t3) ? Pn(e2, n3, 1) : e2 === t3.k ? ot(t3, { k: e2, v: n3 }) : e2 < t3.k ? mn(ot(t3, { l: pt(t3.l, e2, n3) })) : mn(ot(t3, { r: pt(t3.r, e2, n3) }));
}
function Kt() {
  return oe;
}
...
function Le(t3, e2) {
  ...
  if (e2 === n3) {
    ...
    {
      const [s3, i3] = Vn(o3);
      return ge(ot(t3, { k: s3, l: zn(o3), v: i3 }));
    }
...
function zn(t3) {
  return j(t3.r) ? t3.l : ge(ot(t3, { r: zn(t3.r) }));
}
function Ee(t3) {
...
function yo(t3, e2) {
  ...
  for (const o3 of e2) {
    ...
    for (const { end: p2, start: S3, value: g2 } of l2)
      c2 ? (r3 >= S3 || s3 === g2) && (t3 = Le(t3, S3)) : (a2 = g2 !== s3, c2 = true), p2 > r3 && r3 >= S3 && g2 !== s3 && (t3 = pt(t3, r3 + 1, g2));
    a2 && (t3 = pt(t3, i3, s3));
  }
  return [t3, n3];
}
...
function bo({ offset: t3 }, e2) {
  return e2 === t3 ? 0 : e2 < t3 ? -1 : 1;
}
function ie(t3, e2, n3) {
  if (e2.length === 0)
    return 0;
  const { index: o3, offset: r3, size: s3 } = Wn(e2, t3, De), i3 = t3 - o3, l2 = s3 * i3 + (i3 - 1) * n3 + r3;
...
function Ho(t3, e2, n3, o3 = 0) {
  return o3 > 0 && (e2 = Math.max(e2, Wn(t3, o3, De).offset)), Ln(wo(t3, e2, n3, bo), ko);
}
function Eo(t3, [e2, n3, o3, r3]) {
  e2.length > 0 && o3("received item sizes", e2, mt.DEBUG);
  const s3 = t3.sizeTree;
  let i3 = s3, l2 = 0;
  if (n3.length > 0 && j(s3) && e2.length === 2) {
    const g2 = e2[0].size, h2 = e2[1].size;
    i3 = n3.reduce((w3, v2) => pt(pt(w3, v2, g2), v2 + 1, h2), i3);
  } else
    [i3, l2] = yo(i3, e2);
  if (i3 === s3)
    return t3;
  const { lastIndex: c2, lastOffset: a2, lastSize: p2, offsetTree: S3 } = Pe(t3.offsetTree, l2, i3, r3);
  return {
    groupIndices: n3,
    groupOffsetTree: n3.reduce((g2, h2) => pt(g2, h2, ie(h2, S3, r3)), Kt()),
    lastIndex: c2,
    lastOffset: a2,
    lastSize: p2,
    offsetTree: S3,
...
function Pe(t3, e2, n3, o3) {
  ...
  if (e2 !== 0) {
    ...
    const p2 = Ct(n3, e2 - 1);
    s3 = p2[0], i3 = p2[1], r3.length && r3[c2].size === Ct(n3, e2)[1] && (c2 -= 1), r3 = r3.slice(0, c2 + 1);
  } else
    r3 = [];
  for (const { start: a2, value: p2 } of ye(n3, e2, 1 / 0)) {
...
var Et = U(
  ([{ log: t3 }, { recalcInProgress: e2 }]) => {
    const n3 = $(), o3 = $(), r3 = ct(o3, 0), s3 = $(), i3 = $(), l2 = C(0), c2 = C([]), a2 = C(void 0), p2 = C(void 0), S3 = C((I, f2) => wt(I, Oo[f2])), g2 = C(void 0), h2 = C(0), w3 = vo(), v2 = ct(
      x(n3, _(c2, t3, h2), Rt(Eo, w3), Z()),
      w3
    ), m2 = ct(
      x(
        c2,
        Z(),
        Rt((I, f2) => ({ current: f2, prev: I.current }), {
          current: [],
          prev: []
        }),
        E(({ prev: I }) => I)
    ...
    O(
      x(
        ...
        _(v2, h2),
        E(([I, f2, b2]) => {
          const k2 = I.reduce((F, L, V) => pt(F, L, ie(L, f2.offsetTree, b2) || V), Kt());
          return {
            ...f2,
            groupIndices: I,
            groupOffsetTree: k2
      ...
      x(
        o3,
        _(v2),
        P(([I, { lastIndex: f2 }]) => I < f2),
        E(([I, { lastIndex: f2, lastSize: b2 }]) => [
          {
            endIndex: f2,
            size: b2,
            startIndex: I
    ...
    K(
      x(
        l2,
        Rt(
          (I, f2) => ({ diff: I.prev - f2, prev: f2 }),
          { diff: 0, prev: 0 }
        ),
        E((I) => I.diff)
      ),
      (I) => {
        const { groupIndices: f2 } = st(v2);
        if (I > 0)
          G(e2, true), G(s3, I + pn(I, f2));
        else if (I < 0) {
          const b2 = st(m2);
          b2.length > 0 && (I -= pn(-I, b2)), G(i3, I);
        }
      }
    ), K(x(l2, _(t3)), ([I, f2]) => {
      I < 0 && f2(
    ...
    O(
      x(
        ...
        _(v2),
        E(([I, f2]) => {
          const b2 = f2.groupIndices.length > 0, k2 = [], F = f2.lastSize;
          if (b2) {
            const L = re(f2.sizeTree, 0);
            let V = 0, D = 0;
            for (; V < I; ) {
              const B = f2.groupIndices[D], Y = f2.groupIndices.length === D + 1 ? 1 / 0 : f2.groupIndices[D + 1] - B - 1;
              k2.push({
                endIndex: B,
                size: L,
                startIndex: B
            ...
            const J = Gt(f2.sizeTree);
            return V !== I && J.shift(), J.reduce(
              (B, { k: Y, v: it }) => {
                let dt2 = B.ranges;
                return B.prevSize !== 0 && (dt2 = [
                  ...B.ranges,
                  {
                    endIndex: Y + I - 1,
                    size: B.prevSize,
      ...
      x(
        ...
        E(([I, f2, b2]) => {
          if (f2.groupIndices.length > 0) {
            ...
            if (F = Gt(f2.sizeTree).reduce((B, { k: Y, v: it }) => pt(B, Math.max(0, Y + I), it), F), V !== -I) {
              const B = re(f2.sizeTree, J);
              F = pt(F, 0, B);
              const Y = Ct(f2.sizeTree, -I + 1)[1];
              F = pt(F, 1, Y);
            }
            return {
              ...f2,
              sizeTree: F,
              ...Pe(f2.offsetTree, 0, F, b2)
            };
          } else {
            const F = Gt(f2.sizeTree).reduce((L, { k: V, v: D }) => pt(L, Math.max(0, V + I), D), Kt());
            return {
              ...f2,
              sizeTree: F,
              ...Pe(f2.offsetTree, 0, F, b2)
  ...
  ([{ groupIndices: t3, sizes: e2, totalCount: n3 }, { headerHeight: o3, scrollTop: r3 }]) => {
    ...
    return O(
      ...
      x(
        rt(r3, e2, o3),
        P(([c2, a2]) => Re(a2)),
        E(([c2, a2, p2]) => Ct(a2.groupOffsetTree, Math.max(c2 - p2, 0), "v")[0]),
        Z(),
        E((c2) => [c2])
      ),
      i3
...
var Pt = U(
  ([{ log: t3 }]) => {
    ...
    return K(e2, (o3) => {
      o3 && st(t3)("props updated", {}, mt.DEBUG);
...
function Dn(t3) {
  ...
  return e2.align || (e2.align = "start"), (!e2.behavior || !zo) && (e2.behavior = "auto"), e2.offset || (e2.offset = 0), e2;
}
var ce = U(
  ([
    { gap: t3, listRefresh: e2, sizes: n3, totalCount: o3 },
    {
      ...
      scrollTo: a2,
      smoothScrollTargetReached: p2,
      viewportHeight: S3
    },
    { log: g2 }
  ]) => {
    const h2 = $(), w3 = $(), v2 = C(0);
    let m2 = null, d2 = null, u2 = null;
    function T() {
      m2 && (m2(), m2 = null), u2 && (u2(), u2 = null), d2 && (clearTimeout(d2), d2 = null), G(c2, false);
    }
    return O(
      x(
        h2,
        _(n3, S3, o3, v2, l2, i3, g2),
        _(t3, s3, r3),
        E(
          ([
            [R, I, f2, b2, k2, F, L, V],
            ...
            const B = Dn(R), { align: Y, behavior: it, offset: dt2 } = B, St = b2 - 1, ft2 = _n(B, I, St);
            let ut = ie(ft2, I.offsetTree, D) + F;
            Y === "end" ? (ut += J + Ct(I.sizeTree, ft2)[1] - f2 + nt, ft2 === St && (ut += L)) : Y === "center" ? ut += (J + Ct(I.sizeTree, ft2)[1] - f2 + nt) / 2 : ut -= k2, dt2 && (ut += dt2);
            const At = (xt) => {
              T(), xt ? (V("retrying to scroll to", { location: R }, mt.DEBUG), G(h2, R)) : (G(w3, true), V("list did not change, scroll successful", {}, mt.DEBUG));
            };
            if (T(), it === "smooth") {
              let xt = false;
              u2 = K(e2, (Xt) => {
              ...
              m2 = bt(x(e2, Vo(150)), At);
            return d2 = setTimeout(() => {
              T();
            }, 1200), G(c2, true), V("scrolling from index to", { behavior: it, index: ft2, top: ut }, mt.DEBUG), { behavior: it, top: ut };
          }
        )
      ),
      a2
...
var ue = U(
  ([{ defaultItemSize: t3, listRefresh: e2, sizes: n3 }, { scrollTop: o3 }, { scrollTargetReached: r3, scrollToIndex: s3 }, { didMount: i3 }]) => {
    const l2 = C(true), c2 = C(0), a2 = C(true);
    return O(
      x(
        i3,
        _(c2),
      ...
      x(
        rt(e2, i3),
        _(l2, n3, t3, a2),
        P(([[, p2], S3, { sizeTree: g2 }, h2, w3]) => p2 && (!j(g2) || Me(h2)) && !S3 && !w3),
        _(c2)
      ),
      ([, p2]) => {
        bt(r3, () => {
...
var ae = U(([{ footerHeight: t3, headerHeight: e2, scrollBy: n3, scrollContainerState: o3, scrollTop: r3, viewportHeight: s3 }]) => {
  const i3 = C(false), l2 = C(true), c2 = $(), a2 = $(), p2 = C(4), S3 = C(Mo), g2 = ct(
    x(
      dn(x(A(r3), jt(1), yt(true)), x(A(r3), jt(1), yt(false), an(100))),
      Z()
    ),
    false
  ), h2 = ct(
    x(dn(x(n3, yt(true)), x(n3, yt(false), an(200))), Z()),
    false
  );
  O(
    x(
  ...
  const w3 = ht(
    x(
      rt(o3, A(s3), A(e2), A(t3), A(p2)),
      Rt((u2, [{ scrollHeight: T, scrollTop: R }, I, f2, b2, k2]) => {
        const F = R + I - T > -k2, L = {
          scrollHeight: T,
          scrollTop: R,
          viewportHeight: I
        ...
        if (F) {
          let D, J;
          return R > u2.state.scrollTop ? (D = "SCROLLED_DOWN", J = u2.state.scrollTop - R) : (D = "SIZE_DECREASED", J = u2.state.scrollTop - R || u2.scrollTopDelta), {
            atBottom: true,
            atBottomBecause: D,
            scrollTopDelta: J,
            state: L
        ...
        let V;
        return L.scrollHeight > u2.state.scrollHeight ? V = "SIZE_INCREASED" : I < u2.state.viewportHeight ? V = "VIEWPORT_HEIGHT_DECREASING" : R < u2.state.scrollTop ? V = "SCROLLING_UPWARDS" : V = "NOT_FULLY_SCROLLED_TO_LAST_ITEM_BOTTOM", {
          atBottom: false,
    ...
    x(
      o3,
      Rt(
        (u2, { scrollHeight: T, scrollTop: R, viewportHeight: I }) => {
  ...
  O(
    x(
      ...
      Z(),
      Rt(
        (u2, T) => st(h2) ? { direction: u2.direction, prevScrollTop: T } : { direction: T < u2.prevScrollTop ? le : te, prevScrollTop: T },
        { direction: te, prevScrollTop: 0 }
      ),
      E((u2) => u2.direction)
    ),
    m2
  ), O(x(o3, Lt(50), yt(Po)), m2);
  const d2 = C(0);
  return O(
    x(
      g2,
...
var Ke = U(
  ([{ deviation: t3, fixedHeaderHeight: e2, headerHeight: n3, scrollTop: o3, viewportHeight: r3 }]) => {
    const s3 = $(), i3 = C(0), l2 = C(0), c2 = C(0), a2 = ct(
      x(
        rt(
          A(o3),
          A(r3),
        ...
        E(
          ([
            ...
            const R = p2 - u2, I = m2 + d2, f2 = Math.max(g2 - R, 0);
            let b2 = hn;
            const k2 = In(T, xe), F = In(T, Te);
            return h2 -= u2, h2 += g2 + d2, w3 += g2 + d2, w3 -= u2, h2 > p2 + I - k2 && (b2 = le), w3 < p2 - f2 + S3 + F && (b2 = te), b2 !== hn ? [
              Math.max(R - g2 - gn(v2, xe, b2) - k2, 0),
              R - f2 - d2 + S3 + gn(v2, Te, b2) + F
            ] : null;
          }
        ),
        P((p2) => p2 != null),
...
function Ie(t3, e2, n3, o3, r3, s3) {
  ...
  if (t3.length > 0) {
    ...
    p2 = v2.offset + v2.size;
  }
  const S3 = n3 - i3, g2 = l2 + S3 * c2 + (S3 - 1) * o3, h2 = a2, w3 = g2 - p2;
  return {
    bottom: p2,
    firstItemIndex: s3,
    items: Sn(t3, r3, s3),
    ...
    topListHeight: e2.reduce((v2, m2) => m2.size + v2, 0),
    totalCount: n3
  };
}
function Un(t3, e2, n3, o3, r3, s3) {
  ...
  if (n3.groupIndices.length > 0)
    for (const p2 of n3.groupIndices) {
      if (p2 - i3 >= t3)
        break;
      i3++;
    }
  const l2 = t3 + i3, c2 = Ue(e2, l2), a2 = Array.from({ length: l2 }).map((p2, S3) => ({
    data: s3[S3 + c2],
    index: S3 + c2,
    offset: 0,
    size: 0
...
function Sn(t3, e2, n3) {
  ...
  let l2, c2 = 0;
  for (const a2 of t3) {
    (!l2 || l2.end < a2.index) && (l2 = i3.shift(), c2 = e2.groupIndices.indexOf(l2.start));
    let p2;
    a2.index === l2.start ? p2 = {
      index: c2,
      type: "group"
    } : p2 = {
      groupIndex: c2,
      index: a2.index - (c2 + 1) + n3
    }, s3.push({
      ...p2,
      data: a2.data,
      offset: a2.offset,
...
var Dt = U(
  ([
    ...
    { initialTopMostItemIndex: a2, scrolledToInitialItem: p2 },
    { topListHeight: S3 },
    g2,
    { didMount: h2 },
    { recalcInProgress: w3 }
  ]) => {
    const v2 = C([]), m2 = C(0), d2 = $();
      ...
      x(
        ...
        E(
          ([
            ...
            const Y = F, { offsetTree: it, sizeTree: dt2 } = Y, St = st(m2);
            if (k2 === 0)
              return { ...Be, totalCount: k2 };
            if (f2 === 0 && b2 === 0)
              return St === 0 ? { ...Be, totalCount: k2 } : Un(St, L, F, J, nt, B || []);
            if (j(dt2))
              return St > 0 ? null : Ie(
                Wo(Ue(L, k2), Y, B),
                [],
            ...
            if (D.length > 0) {
              ...
              let Bt = 0;
              for (const y2 of ye(dt2, Mt, vt)) {
                const N2 = y2.value, Q = Math.max(y2.start, Mt), lt2 = Math.min(y2.end, vt);
                for (let tt = Q; tt <= lt2; tt++)
                  ft2.push({ data: B == null ? void 0 : B[tt], index: tt, offset: Bt, size: N2 }), Bt += N2;
              }
            }
            if (!V)
              return Ie([], ft2, k2, nt, Y, J);
            const ut = D.length > 0 ? D[D.length - 1] + 1 : 0, At = Ho(it, f2, b2, ut);
            if (At.length === 0)
              return null;
            const xt = k2 - 1, Xt = ve([], (Mt) => {
              for (const vt of At) {
                const Bt = vt.value;
                let y2 = Bt.offset, N2 = vt.start;
                const Q = Bt.size;
                if (Bt.offset < f2) {
                  N2 += Math.floor((f2 - Bt.offset + nt) / (Q + nt));
                  const tt = N2 - vt.start;
                  y2 += tt * Q + tt * nt;
                }
                N2 < ut && (y2 += (ut - N2) * Q, N2 = ut);
                const lt2 = Math.min(vt.end, xt);
                for (let tt = N2; tt <= lt2 && !(y2 >= b2); tt++)
                  Mt.push({ data: B == null ? void 0 : B[tt], index: tt, offset: y2, size: Q }), y2 += Q + nt;
              }
            });
            return Ie(Xt, ft2, k2, nt, Y, J);
          }
        ),
    ...
    O(
      x(
        t3,
        P(Me),
        E((f2) => f2 == null ? void 0 : f2.length)
      ),
      r3
    ), O(
      x(
        u2,
        E((f2) => f2.topListHeight)
      ),
      S3
    ), O(S3, l2), O(
      x(
        u2,
        E((f2) => [f2.top, f2.bottom])
      ),
      i3
    ), O(
      x(
    ...
    const T = ht(
      x(
        u2,
        P(({ items: f2 }) => f2.length > 0),
        _(r3, t3),
        P(([{ items: f2 }, b2]) => f2[f2.length - 1].originalIndex === b2 - 1),
        E(([, f2, b2]) => [f2 - 1, b2]),
        Z(se),
        E(([f2]) => f2)
      )
      ...
      x(
        u2,
        Lt(200),
        P(({ items: f2, topItems: b2 }) => f2.length > 0 && f2[0].originalIndex === b2.length),
        E(({ items: f2 }) => f2[0].index),
        Z()
      )
    ), I = ht(
      x(
        ...
        P(({ items: f2 }) => f2.length > 0),
        E(({ items: f2 }) => {
          let b2 = 0, k2 = f2.length - 1;
          for (; f2[b2].type === "group" && b2 < k2; )
            b2++;
          for (; f2[k2].type === "group" && k2 > b2; )
            k2--;
          return {
            endIndex: f2[k2].index,
            startIndex: f2[b2].index
          };
        }),
        Z(Mn)
      )
    );
    return { endReached: T, initialItemCount: m2, itemsRendered: d2, listState: u2, rangeChanged: I, startReached: R, topItemsIndexes: v2, ...g2 };
  },
  X(
    Et,
    Nn,
...
var Kn = U(
  ([{ fixedFooterHeight: t3, fixedHeaderHeight: e2, footerHeight: n3, headerHeight: o3 }, { listState: r3 }]) => {
    const s3 = $(), i3 = ct(
      x(
        rt(n3, t3, o3, e2, r3),
        E(([l2, c2, a2, p2, S3]) => l2 + c2 + a2 + p2 + S3.offsetBottom + S3.bottom)
      ),
      0
    );
    return O(A(i3), s3), { totalListHeight: i3, totalListHeightChanged: s3 };
  },
  X(at, Dt),
  { singleton: true }
);
...
var _o = (t3, e2) => typeof t3 == "function" ? xn(t3(e2)) : e2 && xn(t3);
var No = U(
  ([
    { listRefresh: t3, totalCount: e2, fixedItemSize: n3 },
    { atBottomState: o3, isAtBottom: r3 },
    { scrollToIndex: s3 },
    { scrolledToInitialItem: i3 },
    { didMount: l2, propsReady: c2 },
    { log: a2 },
    ...
    K(
      x(
        ...
        E(([[m2, d2], u2, T, R, I]) => {
          let f2 = d2 && R, b2 = "auto";
          return f2 && (b2 = _o(u2, T || I), f2 = f2 && !!b2), { followOutputBehavior: b2, shouldFollow: f2, totalCount: m2 };
        }),
        P(({ shouldFollow: m2 }) => m2)
      ),
      ({ followOutputBehavior: m2, totalCount: d2 }) => {
        h2 && (h2(), h2 = null), st(n3) ? requestAnimationFrame(() => {
          st(a2)("following output to ", { totalCount: d2 }, mt.DEBUG), w3(m2);
        }) : h2 = bt(t3, () => {
          st(a2)("following output to ", { totalCount: d2 }, mt.DEBUG), w3(m2), h2 = null;
        });
      }
    );
    function v2(m2) {
      const d2 = bt(o3, (u2) => {
        m2 && !u2.atBottom && u2.notAtBottomBecause === "SIZE_INCREASED" && !h2 && (st(a2)("scrolling to bottom due to increased size", {}, mt.DEBUG), w3("auto"));
      });
      setTimeout(d2, 100);
    }
    return K(
      x(
        ...
        P(([m2, , d2]) => m2 && d2),
        Rt(
          ({ value: m2 }, [, d2]) => ({ refreshed: m2 === d2, value: d2 }),
      ...
      m2 && !d2.atBottom && d2.notAtBottomBecause === "VIEWPORT_HEIGHT_DECREASING" && w3("auto");
    }), { autoscrollToBottom: g2, followOutput: S3 };
  },
...
var Do = U(
  ([{ data: t3, firstItemIndex: e2, gap: n3, sizes: o3 }, { initialTopMostItemIndex: r3 }, { initialItemCount: s3, listState: i3 }, { didMount: l2 }]) => (O(
    x(
      ...
      P(([, c2]) => c2 !== 0),
      _(r3, o3, e2, n3, t3),
      E(([[, c2], a2, p2, S3, g2, h2 = []]) => Un(c2, a2, p2, S3, g2, h2))
    ),
    i3
  ), {}),
  X(Et, ue, Dt, Pt),
...
var Ko = U(
  ([
    ...
    return O(
      x(
        p2,
        _(e2, c2, n3, s3, r3, o3, l2),
        _(t3),
        E(([[S3, g2, h2, w3, v2, m2, d2, u2], T]) => {
          const { align: R, behavior: I, calculateViewLocation: f2 = Uo, done: b2, ...k2 } = S3, F = _n(S3, g2, w3 - 1), L = ie(F, g2.offsetTree, T) + v2 + m2, V = L + Ct(g2.sizeTree, F)[1], D = u2 + m2, J = u2 + h2 - d2, nt = f2({
            itemBottom: V,
            itemTop: L,
            locationParams: { align: R, behavior: I, ...k2 },
            viewportBottom: J,
            viewportTop: D
          });
          return nt ? b2 && bt(
...
var je = U(([{ scrollContainerState: t3, scrollTo: e2 }]) => {
  ...
  return O(
    x(
      rt(n3, o3),
      E(([{ scrollHeight: l2, scrollTop: c2, viewportHeight: a2 }, { offsetTop: p2 }]) => ({
        scrollHeight: l2,
        scrollTop: Math.max(0, c2 - p2),
        viewportHeight: a2
      }))
    ),
    t3
...
var jo = U(
  ([
    ...
    const a2 = $(), p2 = C(void 0), S3 = C(null), g2 = C(null);
    return O(l2, S3), O(c2, g2), K(
      x(
        a2,
        _(e2, o3, i3, S3, g2, n3)
      ),
      ([h2, w3, v2, m2, d2, u2, T]) => {
        const R = Bo(w3.sizeTree);
        m2 && d2 !== null && u2 !== null && (v2 = d2.scrollTop - u2.offsetTop), v2 -= T, h2({ ranges: R, scrollTop: v2 });
      }
    ), O(x(p2, P(Me), E(qo)), r3), O(
      x(
        s3,
        _(p2),
        P(([, h2]) => h2 !== void 0),
...
var Xo = U(
  ([
    ...
    { listState: c2 },
    { beforeUnshiftWith: a2, gap: p2, shiftWithOffset: S3, sizes: g2 },
    { log: h2 },
    { recalcInProgress: w3 }
  ]) => {
    const v2 = ht(
      x(
        ...
        _(i3),
        Rt(
          ([, d2, u2, T], [{ bottom: R, items: I, offsetBottom: f2, totalCount: b2 }, k2]) => {
            const F = R + f2;
            let L = 0;
            return u2 === b2 && d2.length > 0 && I.length > 0 && (I[0].originalIndex === 0 && d2[0].originalIndex === 0 || (L = F - T, L !== 0 && (L += k2))), [L, I, b2, F];
          },
          [0, [], 0, 0]
        ),
        P(([d2]) => d2 !== 0),
        _(o3, l2, n3, r3, h2, w3),
        P(([, d2, u2, T, , , R]) => !R && !T && d2 !== 0 && u2 === le),
        E(([[d2], , , , , u2]) => (u2("Upward scrolling compensation", { amount: d2 }, mt.DEBUG), d2))
      )
    );
    function m2(d2) {
      d2 > 0 ? (G(e2, { behavior: "auto", top: -d2 }), G(t3, 0)) : (G(t3, 0), G(e2, { behavior: "auto", top: -d2 }));
    }
    return K(x(v2, _(t3, s3)), ([d2, u2, T]) => {
      T && Zo() ? G(t3, u2 - d2) : m2(-d2);
    }), K(
      x(
      ...
      x(
        a2,
        _(g2, p2),
        E(([d2, { groupIndices: u2, lastSize: T, sizeTree: R }, I]) => {
          function f2(b2) {
            return b2 * (T + I);
          }
          if (u2.length === 0)
            return f2(d2);
          {
            ...
            for (; F < d2; ) {
              F++, b2 += k2;
              let V = u2.length === L + 1 ? 1 / 0 : u2[L + 1] - u2[L] - 1;
              F + V > d2 && (b2 -= k2, V = d2 - F + 1), F += V, b2 += f2(V), L++;
            }
            return b2;
          }
        })
      ...
      (d2) => {
        G(t3, d2), requestAnimationFrame(() => {
          G(e2, { top: d2 }), requestAnimationFrame(() => {
            G(t3, 0), G(w3, false);
          });
        });
      }
...
var Yn = U(
  ([
    ...
    { initialItemFinalLocationReached: g2, initialTopMostItemIndex: h2, scrolledToInitialItem: w3 },
    v2,
    m2,
    d2,
    { listState: u2, topItemsIndexes: T, ...R },
    { scrollToIndex: I },
    f2,
    { topItemCount: b2 },
    { groupCounts: k2 },
...
function qe(t3, e2, n3) {
  ...
  function c2(d2, u2) {
    d2.propsReady && G(d2.propsReady, false);
    for (const T of o3) {
      const R = d2[e2.required[T]];
      G(R, u2[T]);
    }
    for (const T of r3)
      if (T in u2) {
        const R = d2[e2.optional[T]];
        G(R, u2[T]);
      }
    d2.propsReady && G(d2.propsReady, true);
  }
  function a2(d2) {
    return s3.reduce((u2, T) => (u2[T] = (R) => {
      const I = d2[e2.methods[T]];
      G(I, R);
    }, u2), {});
  }
  function p2(d2) {
    return i3.reduce((u2, T) => (u2[T] = ho(d2[e2.events[T]]), u2), {});
  }
  const S3 = import_react10.default.forwardRef((d2, u2) => {
    const { children: T, ...R } = d2, [I] = import_react10.default.useState(() => ve(Io(t3), (k2) => {
      c2(k2, R);
    })), [f2] = import_react10.default.useState(un(p2, I));
    pe(() => {
      for (const k2 of i3)
        k2 in R && K(f2[k2], R[k2]);
      return () => {
        Object.values(f2).map(We);
      };
    }, [R, f2, I]), pe(() => {
      c2(I, R);
    }), import_react10.default.useImperativeHandle(u2, cn(a2(I)));
    const b2 = n3;
    return (0, import_jsx_runtime.jsx)(l2.Provider, { value: I, children: n3 ? (0, import_jsx_runtime.jsx)(b2, { ...Qo([...o3, ...r3, ...i3], R), children: T }) : T });
  }), g2 = (d2) => {
    const u2 = import_react10.default.useContext(l2);
    ...
    const T = import_react10.default.useContext(l2)[d2], R = import_react10.default.useCallback(
      (I) => K(T, I),
      [T]
    );
    ...
    const T = import_react10.default.useContext(l2)[d2], [R, I] = import_react10.default.useState(un(st, T));
    return pe(
      () => K(T, (f2) => {
        f2 !== R && I(cn(f2));
      }),
  ...
  }, v2 = import_react10.default.version.startsWith("18") ? h2 : w3;
  return {
    Component: S3,
    useEmitter: (d2, u2) => {
      const R = import_react10.default.useContext(l2)[d2];
      pe(() => K(R, u2), [u2, R]);
    },
    useEmitterValue: v2,
    usePublisher: g2
...
var be = import_react10.default.createContext(void 0);
var Zn = import_react10.default.createContext(void 0);
var Xn = typeof document < "u" ? import_react10.default.useLayoutEffect : import_react10.default.useEffect;
function ke(t3) {
  return "self" in t3;
}
function tr(t3) {
...
function Jn(t3, e2, n3, o3 = Yt, r3, s3) {
  const i3 = import_react10.default.useRef(null), l2 = import_react10.default.useRef(null), c2 = import_react10.default.useRef(null), a2 = import_react10.default.useCallback(
    (g2) => {
      let h2, w3, v2;
      const m2 = g2.target;
      if (tr(m2) || ke(m2)) {
        const u2 = ke(m2) ? m2 : m2.defaultView;
        v2 = s3 ? u2.scrollX : u2.scrollY, h2 = s3 ? u2.document.documentElement.scrollWidth : u2.document.documentElement.scrollHeight, w3 = s3 ? u2.innerWidth : u2.innerHeight;
      } else
        v2 = s3 ? m2.scrollLeft : m2.scrollTop, h2 = s3 ? m2.scrollWidth : m2.scrollHeight, w3 = s3 ? m2.offsetWidth : m2.offsetHeight;
      const d2 = () => {
        t3({
          scrollHeight: h2,
          scrollTop: Math.max(v2, 0),
      ...
      g2.suppressFlushSync ? d2() : import_react_dom3.default.flushSync(d2), l2.current !== null && (v2 === l2.current || v2 <= 0 || v2 === h2 - w3) && (l2.current = null, e2(true), c2.current && (clearTimeout(c2.current), c2.current = null));
    },
    [t3, e2, s3]
  );
  ...
  function p2(g2) {
    const h2 = i3.current;
    if (!h2 || (s3 ? "offsetWidth" in h2 && h2.offsetWidth === 0 : "offsetHeight" in h2 && h2.offsetHeight === 0))
      return;
    const w3 = g2.behavior === "smooth";
    let v2, m2, d2;
    ke(h2) ? (m2 = Math.max(
      wt(h2.document.documentElement, s3 ? "width" : "height"),
      s3 ? h2.document.documentElement.scrollWidth : h2.document.documentElement.scrollHeight
    ), v2 = s3 ? h2.innerWidth : h2.innerHeight, d2 = s3 ? window.scrollX : window.scrollY) : (m2 = h2[s3 ? "scrollWidth" : "scrollHeight"], v2 = wt(h2, s3 ? "width" : "height"), d2 = h2[s3 ? "scrollLeft" : "scrollTop"]);
    const u2 = m2 - v2;
    if (g2.top = Math.ceil(Math.max(Math.min(u2, g2.top), 0)), $n(v2, m2) || g2.top === d2) {
      t3({ scrollHeight: m2, scrollTop: d2, viewportHeight: v2 }), w3 && e2(true);
      return;
    }
    w3 ? (l2.current = g2.top, c2.current && clearTimeout(c2.current), c2.current = setTimeout(() => {
      c2.current = null, l2.current = null, e2(true);
    }, 1e3)) : l2.current = null, s3 && (g2 = { behavior: g2.behavior, left: g2.top }), h2.scrollTo(g2);
  }
  function S3(g2) {
    s3 && (g2 = { behavior: g2.behavior, left: g2.top }), i3.current.scrollBy(g2);
  }
  return { scrollByCallback: S3, scrollerRef: i3, scrollToCallback: p2 };
}
...
var er = U(() => {
  const t3 = C((c2) => `Item ${c2}`), e2 = C(null), n3 = C((c2) => `Group ${c2}`), o3 = C({}), r3 = C(Ze), s3 = C("div"), i3 = C(Yt), l2 = (c2, a2 = null) => ct(
    x(
      o3,
      E((p2) => p2[c2]),
      Z()
...
var or = ({ height: t3 }) => (0, import_jsx_runtime.jsx)("div", { style: { height: t3 } });
...
var Cn = import_react10.default.memo(function({ showTopList: e2 = false }) {
  const n3 = M("listState"), o3 = gt("sizeRanges"), r3 = M("useWindowScroll"), s3 = M("customScrollParent"), i3 = gt("windowScrollContainerState"), l2 = gt("scrollContainerState"), c2 = s3 || r3 ? i3 : l2, a2 = M("itemContent"), p2 = M("context"), S3 = M("groupContent"), g2 = M("trackItemSizes"), h2 = M("itemSize"), w3 = M("log"), v2 = gt("gap"), m2 = M("horizontalDirection"), { callbackRef: d2 } = On(
    o3,
    h2,
    g2,
    e2 ? Yt : c2,
  ...
  ), [u2, T] = import_react10.default.useState(0);
  Qe("deviation", (B) => {
    u2 !== B && T(B);
  });
  const R = M("EmptyPlaceholder"), I = M("ScrollSeekPlaceholder") || or, f2 = M("ListComponent"), b2 = M("ItemComponent"), k2 = M("GroupComponent"), F = M("computeItemKey"), L = M("isSeeking"), V = M("groupIndices").length > 0, D = M("alignToBottom"), J = M("initialItemFinalLocationReached"), nt = e2 ? {} : {
    boxSizing: "border-box",
    ...m2 ? {
      display: "inline-block",
      height: "100%",
      marginLeft: u2 !== 0 ? u2 : D ? "auto" : 0,
      paddingLeft: n3.offsetTop,
      paddingRight: n3.offsetBottom,
      whiteSpace: "nowrap"
    } : {
      marginTop: u2 !== 0 ? u2 : D ? "auto" : 0,
      paddingBottom: n3.offsetBottom,
      paddingTop: n3.offsetTop
    },
    ...J ? {} : { visibility: "hidden" }
  };
  return !e2 && n3.totalCount === 0 && R ? (0, import_jsx_runtime.jsx)(R, { ...q(R, p2) }) : (0, import_jsx_runtime.jsx)(
    f2,
    {
      ...q(f2, p2),
      ...
      ref: d2,
      style: nt,
      children: (e2 ? n3.topItems : n3.items).map((B) => {
        const Y = B.originalIndex, it = F(Y + n3.firstItemIndex, B.data, p2);
        return L ? (0, import_react10.createElement)(
        ...
        ) : B.type === "group" ? (0, import_react10.createElement)(
          k2,
          {
            ...q(k2, p2),
            "data-index": Y,
          ...
          V ? a2(B.index, B.groupIndex, B.data, p2) : a2(B.index, B.data, p2)
        );
      })
    }
  );
...
var ur = import_react10.default.memo(function() {
  ...
  return e2 ? (0, import_jsx_runtime.jsx)(o3, { ref: r3, children: (0, import_jsx_runtime.jsx)(e2, { ...q(e2, s3) }) }) : null;
});
...
function Xe({ useEmitter: t3, useEmitterValue: e2, usePublisher: n3 }) {
  return import_react10.default.memo(function({ children: s3, style: i3, ...l2 }) {
    const c2 = n3("scrollContainerState"), a2 = e2("ScrollerComponent"), p2 = n3("smoothScrollTargetReached"), S3 = e2("scrollerRef"), g2 = e2("context"), h2 = e2("horizontalDirection") || false, { scrollByCallback: w3, scrollerRef: v2, scrollToCallback: m2 } = Jn(
      c2,
      p2,
      a2,
      S3,
    ...
    return t3("scrollTo", m2), t3("scrollBy", w3), (0, import_jsx_runtime.jsx)(
      a2,
      {
...
function Je({ useEmitter: t3, useEmitterValue: e2, usePublisher: n3 }) {
  return import_react10.default.memo(function({ children: s3, style: i3, ...l2 }) {
    const c2 = n3("windowScrollContainerState"), a2 = e2("ScrollerComponent"), p2 = n3("smoothScrollTargetReached"), S3 = e2("totalListHeight"), g2 = e2("deviation"), h2 = e2("customScrollParent"), w3 = e2("context"), v2 = import_react10.default.useRef(null), m2 = e2("scrollerRef"), { scrollByCallback: d2, scrollerRef: u2, scrollToCallback: T } = Jn(
      c2,
      p2,
      a2,
      m2,
    ...
    return Xn(() => {
      var R;
      return u2.current = h2 || ((R = v2.current) == null ? void 0 : R.ownerDocument.defaultView), () => {
        u2.current = null;
      };
    }, [u2, h2]), t3("windowScrollTo", T), t3("scrollBy", d2), (0, import_jsx_runtime.jsx)(
      a2,
      {
        ref: v2,
        "data-virtuoso-scroller": true,
...
var dr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(be), n3 = gt("viewportHeight"), o3 = gt("fixedItemHeight"), r3 = M("alignToBottom"), s3 = M("horizontalDirection"), i3 = import_react10.default.useMemo(
...
var fr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(be), n3 = gt("windowViewportRect"), o3 = gt("fixedItemHeight"), r3 = M("customScrollParent"), s3 = _e(
    n3,
    r3,
    M("skipAnimationFrameInResizeObserver")
  ), i3 = M("alignToBottom");
...
var mr = ({ children: t3 }) => {
  const e2 = M("TopItemListComponent") || "div", n3 = M("headerHeight"), o3 = { ...cr, marginTop: `${n3}px` }, r3 = M("context");
  return (0, import_jsx_runtime.jsx)(e2, { style: o3, ...q(e2, r3), children: t3 });
};
var pr = import_react10.default.memo(function(e2) {
  const n3 = M("useWindowScroll"), o3 = M("topItemsIndexes").length > 0, r3 = M("customScrollParent"), s3 = M("context"), i3 = r3 || n3 ? gr : hr, l2 = r3 || n3 ? fr : dr;
  return (0, import_jsx_runtime.jsxs)(i3, { ...e2, ...q(i3, s3), children: [
    o3 && (0, import_jsx_runtime.jsx)(mr, { children: (0, import_jsx_runtime.jsx)(Cn, { showTopList: true }) }),
...
var qr = eo;
var Ir = U(() => {
  const t3 = C((a2) => (0, import_jsx_runtime.jsxs)("td", { children: [
    "Item $",
    a2
  ] })), e2 = C(null), n3 = C((a2) => (0, import_jsx_runtime.jsxs)("td", { colSpan: 1e3, children: [
    "Group ",
    a2
  ] })), o3 = C(null), r3 = C(null), s3 = C({}), i3 = C(Ze), l2 = C(Yt), c2 = (a2, p2 = null) => ct(
    x(
      s3,
      E((S3) => S3[a2]),
      Z()
...
var xr = ({ height: t3 }) => (0, import_jsx_runtime.jsx)("tr", { children: (0, import_jsx_runtime.jsx)("td", { style: { height: t3 } }) });
var Tr = ({ height: t3 }) => (0, import_jsx_runtime.jsx)("tr", { children: (0, import_jsx_runtime.jsx)("td", { style: { border: 0, height: t3, padding: 0 } }) });
var Cr = { overflowAnchor: "none" };
var wn = { position: Ye(), zIndex: 2, overflowAnchor: "none" };
var vn = import_react10.default.memo(function({ showTopList: e2 = false }) {
  const n3 = W("listState"), o3 = W("computeItemKey"), r3 = W("firstItemIndex"), s3 = W("context"), i3 = W("isSeeking"), l2 = W("fixedHeaderHeight"), c2 = W("groupIndices").length > 0, a2 = W("itemContent"), p2 = W("groupContent"), S3 = W("ScrollSeekPlaceholder") || xr, g2 = W("GroupComponent"), h2 = W("TableRowComponent"), w3 = (e2 ? n3.topItems : []).reduce((m2, d2, u2) => (u2 === 0 ? m2.push(d2.size) : m2.push(m2[u2 - 1] + d2.size), m2), []), v2 = (e2 ? n3.topItems : n3.items).map((m2) => {
    const d2 = m2.originalIndex, u2 = o3(d2 + r3, m2.data, s3), T = e2 ? d2 === 0 ? 0 : w3[d2 - 1] : 0;
    return i3 ? (0, import_react10.createElement)(
    ...
    ) : m2.type === "group" ? (0, import_react10.createElement)(
      g2,
      {
        ...q(g2, s3),
        "data-index": d2,
      ...
      h2,
      {
        ...
        "data-item-index": m2.index,
        "data-known-size": m2.size,
        "data-item-group-index": m2.groupIndex,
        key: u2,
        style: e2 ? { ...wn, top: l2 + T } : Cr
      },
      c2 ? a2(m2.index, m2.groupIndex, m2.data, s3) : a2(m2.index, m2.data, s3)
    );
  });
  return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: v2 });
});
var wr = import_react10.default.memo(function() {
  const e2 = W("listState"), n3 = W("topItemsIndexes").length > 0, o3 = Tt("sizeRanges"), r3 = W("useWindowScroll"), s3 = W("customScrollParent"), i3 = Tt("windowScrollContainerState"), l2 = Tt("scrollContainerState"), c2 = s3 || r3 ? i3 : l2, a2 = W("trackItemSizes"), p2 = W("itemSize"), S3 = W("log"), { callbackRef: g2, ref: h2 } = On(
    o3,
    p2,
    a2,
    c2,
  ...
  ), [w3, v2] = import_react10.default.useState(0);
  tn("deviation", (V) => {
    w3 !== V && (h2.current.style.marginTop = `${V}px`, v2(V));
  });
  const m2 = W("EmptyPlaceholder"), d2 = W("FillerRow") || Tr, u2 = W("TableBodyComponent"), T = W("paddingTopAddition"), R = W("statefulTotalCount"), I = W("context");
  if (R === 0 && m2)
    return (0, import_jsx_runtime.jsx)(m2, { ...q(m2, I) });
  const f2 = (n3 ? e2.topItems : []).reduce((V, D) => V + D.size, 0), b2 = e2.offsetTop + T + w3 - f2, k2 = e2.offsetBottom, F = b2 > 0 ? (0, import_jsx_runtime.jsx)(d2, { context: I, height: b2 }, "padding-top") : null, L = k2 > 0 ? (0, import_jsx_runtime.jsx)(d2, { context: I, height: k2 }, "padding-bottom") : null;
  return (0, import_jsx_runtime.jsxs)(u2, { "data-testid": "virtuoso-item-list", ref: g2, ...q(u2, I), children: [
    F,
    n3 && (0, import_jsx_runtime.jsx)(vn, { showTopList: true }),
    (0, import_jsx_runtime.jsx)(vn, {}),
    L
  ] });
});
var vr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(be), n3 = Tt("viewportHeight"), o3 = Tt("fixedItemHeight"), r3 = Ht(
...
var yr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(be), n3 = Tt("windowViewportRect"), o3 = Tt("fixedItemHeight"), r3 = W("customScrollParent"), s3 = _e(
    n3,
    r3,
    W("skipAnimationFrameInResizeObserver")
  );
...
var Rr = import_react10.default.memo(function(e2) {
  const n3 = W("useWindowScroll"), o3 = W("customScrollParent"), r3 = Tt("fixedHeaderHeight"), s3 = Tt("fixedFooterHeight"), i3 = W("fixedHeaderContent"), l2 = W("fixedFooterContent"), c2 = W("context"), a2 = Ht(
    import_react10.default.useMemo(() => ne(r3, (u2) => wt(u2, "height")), [r3]),
    true,
    W("skipAnimationFrameInResizeObserver")
  ), p2 = Ht(
    import_react10.default.useMemo(() => ne(s3, (u2) => wt(u2, "height")), [s3]),
    true,
    W("skipAnimationFrameInResizeObserver")
  ), S3 = o3 || n3 ? Hr : br, g2 = o3 || n3 ? yr : vr, h2 = W("TableComponent"), w3 = W("TableHeadComponent"), v2 = W("TableFooterComponent"), m2 = i3 ? (0, import_jsx_runtime.jsx)(
    w3,
    {
      ref: a2,
    ...
    "TableHead"
  ) : null, d2 = l2 ? (0, import_jsx_runtime.jsx)(
    v2,
    {
      ref: p2,
  ...
  return (0, import_jsx_runtime.jsx)(S3, { ...e2, ...q(S3, c2), children: (0, import_jsx_runtime.jsx)(g2, { children: (0, import_jsx_runtime.jsxs)(h2, { style: { borderSpacing: 0, overflowAnchor: "none" }, ...q(h2, c2), children: [
    m2,
...
var Fr = U(
  ([
    ...
    { footerHeight: r3, headerHeight: s3, scrollBy: i3, scrollContainerState: l2, scrollTo: c2, scrollTop: a2, smoothScrollTargetReached: p2, viewportHeight: S3 },
    g2,
    h2,
    { didMount: w3, propsReady: v2 },
    { customScrollParent: m2, useWindowScroll: d2, windowScrollContainerState: u2, windowScrollTo: T, windowViewportRect: R },
    I
  ]) => {
    const f2 = C(0), b2 = C(0), k2 = C(yn), F = C({ height: 0, width: 0 }), L = C({ height: 0, width: 0 }), V = $(), D = $(), J = C(0), nt = C(null), B = C({ column: 0, row: 0 }), Y = $(), it = $(), dt2 = C(false), St = C(0), ft2 = C(true), ut = C(false), At = C(false);
    K(
      x(
        w3,
        _(St),
      ...
      x(
        rt(w3, ft2, L, F, St, ut),
        P(([y2, N2, Q, lt2, , tt]) => y2 && !N2 && Q.height !== 0 && lt2.height !== 0 && !tt)
      ),
      ([, , , , y2]) => {
        G(ut, true), $e(1, () => {
          G(V, y2);
      ...
      ([, y2]) => {
        y2 && (G(F, y2.viewport), G(L, y2.item), G(B, y2.gap), y2.scrollTop > 0 && (G(dt2, true), bt(x(a2, jt(1)), (N2) => {
          G(dt2, false);
        }), G(c2, { top: y2.scrollTop })));
      }
    ), O(
      x(
        F,
      ...
      x(
        rt(
          A(F, he),
          A(L, he),
          A(B, (y2, N2) => y2 && y2.column === N2.column && y2.row === N2.row),
          A(a2)
        ),
        E(([y2, N2, Q, lt2]) => ({
          gap: Q,
      ...
      x(
        ...
        E(
          ([
            ...
            const { column: Ot, row: Qt } = lt2, { height: fe, width: He } = tt, { width: en } = kt;
            if ($t === 0 && (y2 === 0 || en === 0))
              return yn;
            if (He === 0) {
              const ln = Ue(Ft, y2), io = ln + Math.max($t - 1, 0);
              return Br(Hn(ln, io, Jt));
            }
            const me = oo(en, He, Ot);
            let Ut, Wt;
            de ? N2 === 0 && Q === 0 && $t > 0 ? (Ut = 0, Wt = $t - 1) : (Ut = me * Ce((N2 + Qt) / (fe + Qt)), Wt = me * Rn((Q + Qt) / (fe + Qt)) - 1, Wt = Oe(y2 - 1, ee(Wt, me - 1)), Ut = Oe(Wt, ee(0, Ut))) : (Ut = 0, Wt = -1);
            const nn = Hn(Ut, Wt, Jt), { bottom: on, top: rn } = En(kt, lt2, tt, nn), sn = Rn(y2 / me), so = sn * fe + (sn - 1) * Qt - on;
      ...
      x(
        rt(F, L, k2, B),
        P(([y2, N2, { items: Q }]) => Q.length > 0 && N2.height !== 0 && y2.height !== 0),
        E(([y2, N2, { items: Q }, lt2]) => {
          const { bottom: tt, top: kt } = En(y2, lt2, N2, Q);
          return [kt, tt];
        }),
        Z(se)
      ),
    ...
    const Xt = ht(
      x(
        rt(k2, f2),
        P(([{ items: y2 }]) => y2.length > 0),
        _(xt),
        P(([[y2, N2], Q]) => {
          const tt = y2.items[y2.items.length - 1].index === N2 - 1;
          return (Q || y2.bottom > 0 && y2.itemHeight > 0 && y2.offsetBottom === 0 && y2.items.length === N2) && tt;
        }),
        E(([[, y2]]) => y2 - 1),
        Z()
      )
      ...
      x(
        A(k2),
        P(({ items: y2 }) => y2.length > 0 && y2[0].index === 0),
        yt(0),
        Z()
      )
    ), vt = ht(
      x(
        A(k2),
        _(dt2),
        P(([{ items: y2 }, N2]) => y2.length > 0 && !N2),
        E(([{ items: y2 }]) => ({
          endIndex: y2[y2.length - 1].index,
          startIndex: y2[0].index
        })),
        Z(Mn),
        Lt(0)
      )
    );
    O(vt, h2.scrollSeekRangeChanged), O(
      x(
        V,
        _(F, L, f2, B),
        E(([y2, N2, Q, lt2, tt]) => {
          const kt = Dn(y2), { align: Jt, behavior: $t, offset: de } = kt;
          let Ft = kt.index;
          Ft === "LAST" && (Ft = lt2 - 1), Ft = ee(0, Ft, Oe(lt2 - 1, Ft));
          let Ot = Ae(N2, tt, Q, Ft);
          return Jt === "end" ? Ot = bn(Ot - N2.height + Q.height) : Jt === "center" && (Ot = bn(Ot - N2.height / 2 + Q.height / 2)), de && (Ot += de), { behavior: $t, top: Ot };
        })
      ),
      c2
    );
    const Bt = ct(
      x(
        k2,
        E((y2) => y2.offsetBottom + y2.bottom)
      ),
      0
    );
    return O(
      x(
        R,
        E((y2) => ({ height: y2.visibleHeight, width: y2.visibleWidth }))
      ),
      F
    ), {
      customScrollParent: m2,
      // input
      data: nt,
      deviation: J,
      footerHeight: r3,
...
function Ae(t3, e2, n3, o3) {
  const r3 = oo(t3.width, n3.width, e2.column), s3 = Ce(o3 / r3), i3 = s3 * n3.height + ee(0, s3 - 1) * e2.row;
  return i3 > 0 ? i3 + e2.row : i3;
}
var Or = U(() => {
  const t3 = C((S3) => `Item ${S3}`), e2 = C({}), n3 = C(null), o3 = C("virtuoso-grid-item"), r3 = C("virtuoso-grid-list"), s3 = C(Ze), i3 = C("div"), l2 = C(Yt), c2 = (S3, g2 = null) => ct(
    x(
      e2,
      E((h2) => h2[S3]),
      Z()
...
var zr = import_react10.default.memo(function() {
  const e2 = et("gridState"), n3 = et("listClassName"), o3 = et("itemClassName"), r3 = et("itemContent"), s3 = et("computeItemKey"), i3 = et("isSeeking"), l2 = It("scrollHeight"), c2 = et("ItemComponent"), a2 = et("ListComponent"), p2 = et("ScrollSeekPlaceholder"), S3 = et("context"), g2 = It("itemDimensions"), h2 = It("gap"), w3 = et("log"), v2 = et("stateRestoreInProgress"), m2 = It("reportReadyState"), d2 = Ht(
    import_react10.default.useMemo(
      () => (u2) => {
        const T = u2.parentElement.parentElement.scrollHeight;
        l2(T);
        const R = u2.firstChild;
        if (R) {
          const { height: I, width: f2 } = R.getBoundingClientRect();
          g2({ height: I, width: f2 });
        }
        h2({
  ...
  return Xn(() => {
    e2.itemHeight > 0 && e2.itemWidth > 0 && m2(true);
  }, [e2]), v2 ? null : (0, import_jsx_runtime.jsx)(
    a2,
    {
      className: n3,
      ref: d2,
...
var Ar = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(Zn), n3 = It("itemDimensions"), o3 = It("viewportDimensions"), r3 = Ht(
    import_react10.default.useMemo(
      () => (s3) => {
...
var Mr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(Zn), n3 = It("windowViewportRect"), o3 = It("itemDimensions"), r3 = et("customScrollParent"), s3 = _e(n3, r3, false);
  return import_react10.default.useEffect(() => {
...
var Wr = import_react10.default.memo(function({ ...e2 }) {
  const n3 = et("useWindowScroll"), o3 = et("customScrollParent"), r3 = o3 || n3 ? Nr : _r, s3 = o3 || n3 ? Mr : Ar, i3 = et("context");
  return (0, import_jsx_runtime.jsx)(r3, { ...e2, ...q(r3, i3), children: (0, import_jsx_runtime.jsxs)(s3, { children: [
...
function useWatch(props) {
  ...
  const [value, updateValue] = import_react11.default.useState(control._getWatch(name, _defaultValue.current));
  useIsomorphicLayoutEffect2(() => control._subscribe({
    name,
    formState: {
      values: true
...
var ItemContainer = (0, import_react17.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime2.jsx)(StyledItemContainer, { ref, ...rest });
});
...
var ListContainer = (0, import_react17.forwardRef)((props, ref) => {
  const { context, ...rest } = props;
  return (0, import_jsx_runtime2.jsx)(StyledListContainer, { ref, ...rest });
});
